...
amis.define("e874872", function (e, t, r, n) {
  var i, o;
  (i = this),
    (o = function () {
      "use strict";
      var e = navigator.userAgent,
        ...
        m = /Android/.test(e),
        y =
          v || m || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(e),
        b = v || /Mac/.test(t),
        w = /\bCrOS\b/.test(e),
        x = /win/i.test(t),
      ...
      var Pe,
        ...
        ze =
          "oncopy" in (Pe = A("div")) ||
          (Pe.setAttribute("oncopy", "return;"),
          "function" == typeof Pe.oncopy),
        Ie = null,
        Be = {},
        Ge = {};
      function Ue(e, t) {
      ...
      (qe.prototype.eol = function () {
        ...
        (qe.prototype.column = function () {
          return (
            ...
            this.lastColumnValue -
              (this.lineStart
                ? V(this.string, this.lineStart, this.tabSize)
                : 0)
          );
        }),
        ...
        var o = (function (e, t, r) {
            for (
              ...
              if (
                u &&
                (!r ||
                  s + (u instanceof pt ? u.lookAhead : 0) <= o.modeFrontier)
              )
                return s;
      ...
      function rn(e, t, r, n) {
        return (
          r || (r = Er(e, t)), tn(e, t, r, $r(e, t, Rr(e, r, n), "line").top)
        );
      }
      function nn(e, t, r, n) {
      ...
      function fn(e) {
        var t = an(e.display),
          ...
          n =
            r &&
            Math.max(5, e.display.scroller.clientWidth / un(e.display) - 3);
        return function (i) {
      ...
      function pn(e, t, r, n) {
        ...
        if (n && u.xRel > 0 && (a = Ze(e.doc, u.line).text).length == u.ch) {
          ...
          u = ot(
            ...
            Math.max(
              0,
              Math.round((o - Or(e.display).left) / un(e.display)) - c,
            ),
          );
        }
        return u;
          ...
          if (t || s != r.sel.primIndex) {
            ...
            if (
              ...
              if (l) {
                ...
                (u || e.options.showCursorWhenSelecting) && Sn(e, a.head, i);
              u || kn(e, a, o);
            }
          }
        return n;
      ...
      function ti(e) {
        ...
        e.updatedDisplay && Dn(t),
          ...
          r.maxLineChanged &&
            ...
            ((e.adjustWidthTo =
              Fr(t, r.maxLine, r.maxLine.text.length).left + 3),
          ...
          var i = (function (e, t, r, n) {
            ...
            null == n && (n = 0),
              e.options.lineWrapping ||
                t != r ||
                ((r =
                  "before" == t.sticky ? ot(t.line, t.ch + 1, "before") : t),
                (t = t.ch
        ...
        for (var r = t.viewport, n = !0; ; n = !1) {
          if (n && e.options.lineWrapping && t.oldDisplayWidth != Dr(e))
            ...
            (r &&
              null != r.top &&
              (r = {
                top: Math.min(e.doc.height + Nr(e.display) - Wr(e), r.top),
              }),
      ...
      function Ji(e, t, r, n, i) {
        null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
          io(e, new Mi([Qi(e.sel.primary(), t, r, i)], 0), n);
      }
      function eo(e, t, r) {
        for (
        ...
        io(e, Oi(e.cm, n, e.sel.primIndex), r);
      }
      function to(e, t, r, n) {
        var i = e.sel.ranges.slice(0);
        (i[t] = r), io(e, Oi(e.cm, i, e.sel.primIndex), n);
      }
      function ro(e, t, r, n) {
        io(e, Ai(t, r), n);
      }
      function no(e, t, r) {
        var n = e.history.done,
          i = J(n);
        i && i.ranges ? ((n[n.length - 1] = t), oo(e, t, r)) : io(e, t, r);
      }
      function io(e, t, r) {
        oo(e, t, r), Xi(e, e.sel, e.cm ? e.cm.curOp.id : NaN, r);
      }
      function oo(e, t, r) {
      ...
      function so(e) {
        lo(e, ao(e, e.sel, null, !1));
      }
      function ao(e, t, r, n) {
        for (var i, o = 0; o < t.ranges.length; o++) {
          var l = t.ranges[o],
            s = t.ranges.length == e.sel.ranges.length && e.sel.ranges[o],
            a = co(e, l.anchor, s && s.anchor, r, n),
            u = l.head == l.anchor ? a : co(e, l.head, s && s.head, r, n);
          ...
          for (var l = 0; l < o.markedSpans.length; ++l) {
            ...
            if (
              ...
              if (r) {
                ...
                if (
                  ((n < 0 ? c : u) &&
                    (h = ho(e, h, -n, h && h.line == t.line ? o : null)),
                  h &&
                    h.line == t.line &&
                    (f = lt(h, r)) &&
                    (n < 0 ? f < 0 : f > 0))
              ...
              return (
                (n < 0 ? u : c) &&
                  (d = ho(e, d, n, d.line == t.line ? o : null)),
                d ? uo(e, d, t, n, i) : null
              );
            }
          }
      ...
      function go(e, t, r) {
        if (e.cm) {
          if (!e.cm.curOp) return oi(e.cm, go)(e, t, r);
      ...
      function vo(e, t) {
        if (1 != t.text.length || "" != t.text[0] || 0 != lt(t.from, t.to)) {
          var r = Hi(e, t);
          ji(e, t, r, e.cm ? e.cm.curOp.id : NaN), bo(e, t, r, Dt(e, t));
          var n = [];
          Ii(e, function (e, r) {
            r || -1 != j(n, e.history) || (So(e.history, t), n.push(e.history)),
              bo(e, t, null, Dt(e, t));
          });
        }
      }
        ...
        if (!n || r) {
          ...
          if (u != s.length) {
            for (o.lastOrigin = o.lastSelOrigin = null; ; ) {
              ...
              if ((Yi(i, a), r && !i.equals(e.sel)))
                return void io(e, i, { clearRedo: !1 });
              l = i;
            }
            var c = [];
            Yi(l, a),
              ...
              var h =
                ...
                f = function (r) {
                  ...
                  bo(e, n, o, qi(e, n)),
                    !r &&
                      e.cm &&
                      e.cm.scrollIntoView({ from: n.from, to: Di(n) });
                  var l = [];
                  Ii(e, function (e, t) {
                    t ||
                      -1 != j(l, e.history) ||
                      (So(e.history, n), l.push(e.history)),
                      bo(e, n, null, qi(e, n));
                  });
                },
      ...
      function bo(e, t, r, n) {
        if (e.cm && !e.cm.curOp) return oi(e.cm, bo)(e, t, r, n);
        if (t.to.line < e.first)
          yo(e, t.text.length - 1 - (t.to.line - t.from.line));
          ...
          t.to.line > o &&
            ...
            e.cm
                    ...
                    (function (e, t) {
                      if (
                        ...
                        for (var r = e.first, n = t - 1; n > r; n--) {
                          ...
                          if (
                            i &&
                            (!(i instanceof pt) || n + i.lookAhead < t)
                          ) {
                            r = n + 1;
                            break;
                          }
              ...
              : zi(e, t, n),
            oo(e, r, Y),
            e.cantEdit && co(e, ot(e.firstLine(), 0)) && (e.cantEdit = !1);
        }
      }
      function wo(e, t, r, n, i) {
        ...
        n || (n = r),
          ...
          go(e, { from: r, to: n, text: t, origin: i });
      }
      function xo(e, t, r, n) {
        ...
        for (var i = 0; i < e.length; ++i) {
          ...
          if (o.ranges) {
            ...
            for (var s = 0; s < o.ranges.length; s++)
              xo(o.ranges[s].anchor, t, r, n), xo(o.ranges[s].head, t, r, n);
          } else {
        ...
        (To.prototype = {
              ...
              if (e <= o) {
                if ((i.insertInner(e, t, r), i.lines && i.lines.length > 50)) {
                  for (
                    ...
                    var a = new ko(i.lines.slice(s, (s += 25)));
                    (i.height -= a.height),
          ...
          maybeSpill: function () {
            if (!(this.children.length <= 10)) {
              var e = this;
              do {
                var t = new To(e.children.splice(e.children.length - 5, 5));
                if (e.parent) {
                  (e.size -= t.size), (e.height -= t.height);
                  var r = j(e.parent.children, e);
                  e.parent.children.splice(r + 1, 0, t);
                } else {
                  var n = new To(e.children);
      ...
      function Do(e, t, r, n, i) {
        ...
        if (e.cm && !e.cm.curOp) return oi(e.cm, Do)(e, t, r, n, i);
        var o = new Ao(e, i),
          l = lt(t, r);
        ...
        o.addToHistory &&
          ji(e, { from: t, to: r, origin: "markText" }, e.sel, NaN);
        var s,
          a = t.line,
          u = e.cm;
        if (
          ...
          o.atomic && so(u.doc), fr(u, "markerAdded", u, o);
        }
        return o;
      }
        ...
        if (!this.explicitlyCleared) {
          ...
          for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
            ...
            e && !this.collapsed
              ? mn(e, tt(l), "text")
              : e &&
                (null != s.to && (i = tt(l)), null != s.from && (n = tt(l))),
          ...
          null != n && e && this.collapsed && vn(e, n, i + 1),
            ...
            this.atomic &&
              this.doc.cantEdit &&
              ((this.doc.cantEdit = !1), e && so(e.doc)),
        ...
        (Ao.prototype.find = function (e, t) {
          ...
          for (var i = 0; i < this.lines.length; ++i) {
            ...
            if (null != l.from && ((r = ot(t ? o : tt(o), l.from)), -1 == e))
              return r;
            if (null != l.to && ((n = ot(t ? o : tt(o), l.to)), 1 == e))
              return n;
          }
      ...
      var Po = 0,
        Eo = function (e, t, r, n, i) {
          ...
          null == r && (r = 0),
            To.call(this, [new ko([new Zt("", null)])]),
            (this.first = r),
      ...
      (Eo.prototype = re(To.prototype, {
        ...
        replaceRange: function (e, t, r, n) {
          wo(this, e, (t = ft(this, t)), (r = r ? ft(this, r) : t), n);
        },
        ...
        extendSelection: si(function (e, t, r) {
          Ji(this, ft(this, e), t && ft(this, t), r);
        }),
        extendSelections: si(function (e, t) {
          eo(this, dt(this, e), t);
        }),
        extendSelectionsBy: si(function (e, t) {
          eo(this, dt(this, ee(this.sel.ranges, e)), t);
        }),
        ...
        replaceSelections: si(function (e, t, r) {
          ...
          for (
            ...
            go(this, n[a]);
          s ? no(this, s) : this.cm && En(this.cm);
        }),
        undo: si(function () {
          mo(this, "undo");
        }),
        ...
        setBookmark: function (e, t) {
          ...
          return Do(this, (e = ft(this, e)), e, r, "bookmark");
        },
            ...
            (function (e, t) {
              for (var r = 0; r < t.length; r++) {
                var n = t[r],
                  ...
                  l = e.clipPos(i.to);
                if (lt(o, l)) {
                  var s = Do(e, o, l, n.primary, n.primary.type);
          ...
          if ((e instanceof Wl && (e = e.doc), this.linked))
            for (var t = 0; t < this.linked.length; ++t)
              if (this.linked[t].doc == e) {
                this.linked.splice(t, 1), e.unlinkDoc(this), Fo(Ho(this));
                break;
              }
                  ...
                  a = function () {
                    ++s == i &&
                      oi(t, function () {
                        ...
                        go(t.doc, e),
                          no(t.doc, Ai(ft(t.doc, r), ft(t.doc, Di(e))));
                      })();
                  },
                  u = function (e, r) {
                    if (
                ...
                if (h) {
                  ...
                  if (
                    ...
                    for (var d = 0; d < f.length; ++d)
                      wo(t.doc, "", f[d].anchor, f[d].head, "drag");
      ...
      for (
        ...
        Ko[jo + 48] = Ko[jo + 96] = String(jo);
      for (var Xo = 65; Xo <= 90; Xo++) Ko[Xo] = String.fromCharCode(Xo);
      ...
      function qo(e) {
        ...
        for (var r in e)
          if (e.hasOwnProperty(r)) {
            ...
            for (var i = ee(r.split(" "), _o), o = 0; o < i.length; o++) {
              var l = void 0,
                s = void 0;
              o == i.length - 1
                ? ((s = i.join(" ")), (l = n))
      ...
      function Zo(e, t, r, n) {
        var i = (t = tl(t)).call ? t.call(e, n) : t[e];
        if (!1 === i) return "nothing";
        if ("..." === i) return "multi";
        if (null != i && r(i)) return "handled";
        if (t.fallthrough) {
          if ("[object Array]" != Object.prototype.toString.call(t.fallthrough))
            return Zo(e, t.fallthrough, r, n);
          for (var o = 0; o < t.fallthrough.length; o++) {
            var l = Zo(e, t.fallthrough[o], r, n);
            if (l) return l;
          }
        }
      }
      function Qo(e) {
        var t = "string" == typeof e ? e : Ko[e.keyCode];
      ...
      function rl(e, t) {
        ...
        ii(e, function () {
          for (var t = n.length - 1; t >= 0; t--)
            wo(e.doc, "", n[t].from, n[t].to, "+delete");
          En(e);
        });
      }
      function nl(e, t, r) {
      ...
      ($o.basic = {
        ...
        ($o.default = b ? $o.macDefault : $o.pcDefault);
      var ll = {
        selectAll: fo,
          ...
          return e.extendSelectionsBy(
            function (t) {
              return (function (e, t) {
                ...
                return n != r && (t = tt(n)), ol(!0, e, r, t, -1);
              })(e, t.head.line);
            },
            { origin: "+move", bias: -1 },
          );
        ...
        goLineLeftSmart: function (e) {
          return e.extendSelectionsBy(function (t) {
            ...
            return n.ch < e.getLine(n.line).search(/\S/) ? al(e, t.head) : n;
          }, _);
        },
        goLineUp: function (e) {
          ...
          return ii(e, function () {
            for (var t = e.listSelections(), r = [], n = 0; n < t.length; n++)
              if (t[n].empty()) {
                ...
                if (o)
                  if (
                    (i.ch == o.length && (i = new ot(i.line, i.ch - 1)),
                    i.ch > 0)
                  )
      ...
      function sl(e, t) {
        var r = Ze(e.doc, t),
          n = Vt(r);
        return n != r && (t = tt(n)), ol(!0, e, n, t, 1);
      }
      function al(e, t) {
        var r = sl(e, t.line),
          n = Ze(e.doc, r.line),
      ...
      function fl(e, t, r, n) {
        var i = (function (e, t, r) {
          for (var n = 0; n < e.state.keyMaps.length; n++) {
            var i = Zo(t, e.state.keyMaps[n], r, e);
            if (i) return i;
          }
          return (
            (e.options.extraKeys && Zo(t, e.options.extraKeys, r, e)) ||
            Zo(t, e.options.keyMap, r, e)
          );
        })(e, t, n);
        return (
      ...
      function ml(e) {
        ...
        if (
          ...
          var r = e.keyCode,
            n = e.charCode;
          if (f && r == pl) return (pl = null), void Le(e);
          if (!f || (e.which && !(e.which < 10)) || !dl(t, e)) {
            var i = String.fromCharCode(null == n ? r : n);
            "\b" != i &&
              ((function (e, t, r) {
                return hl(e, "'" + r + "'", t, function (t) {
                  return ul(e, t, !0);
                });
              })(t, e, i) ||
          ...
          if ((r.input.ensurePolled(), (r.shift = e.shiftKey), Tr(r, e)))
            ...
            var n = pn(t, e),
              ...
              o = n
                ? (function (e, t) {
                    var r = +new Date();
                    return bl && bl.compare(r, e, t)
                      ? ((yl = bl = null), "triple")
                      : yl && yl.compare(r, e, t)
                        ? ((bl = new wl(r, e, t)), (yl = null), "double")
                        : ((yl = new wl(r, e, t)), (bl = null), "single");
                  })(n, i)
                : "single";
            B(t).focus(),
                        ...
                        (lt(i.to(), t) > 0 || t.xRel < 0)
                          ...
                          : (function (e, t, r, n) {
                              ...
                              if (
                                ...
                                var h = Cl(e, r, n.unit);
                                s = n.extend
                                  ? Qi(s, h.anchor, h.head, n.extend)
                                  : h;
                              }
                              n.addNew
                                ? -1 == a
                                  ? ((a = c.length),
                                    io(o, Oi(e, c.concat([s]), a), {
                                      scroll: !1,
                                      origin: "*mouse",
                                    }))
                                  : c.length > 1 &&
                              ...
                              function m(t) {
                                (e.state.selectingText = !1),
                                  ...
                                  ye(i.wrapper.ownerDocument, "mousemove", y),
                                  ye(i.wrapper.ownerDocument, "mouseup", b),
                                  (o.history.lastSelOrigin = null);
                              }
                              var y = oi(e, function (e) {
                                  0 !== e.buttons && Oe(e) ? v(e) : m(e);
                                }),
                                b = oi(e, m);
      ...
      function Cl(e, t, r) {
        ...
        if ("line" == r)
          return new Ni(ot(t.line, 0), ft(e.doc, ot(t.line + 1, 0)));
        var n = r(e, t);
      ...
      function kl(e, t) {
        Tr(e.display, t) ||
          (function (e, t) {
            return (
              !!Ce(e, "gutterContextMenu") && Sl(e, t, "gutterContextMenu", !1)
            );
          })(e, t) ||
          we(e, t, "contextmenu") ||
          L ||
      ...
      function Wl(e, t) {
        ...
        var n = t.value;
        "string" == typeof n
          ? (n = new Eo(n, t.mode, null, t.lineSeparator, t.direction))
        ...
        (function (e) {
          var t = e.display;
          ve(t.scroller, "mousedown", oi(e, xl)),
            ve(
              t.scroller,
              "dblclick",
              l && s < 11
            ...
            ve(t.input.getField(), "contextmenu", function (r) {
              t.scroller.contains(r.target) || kl(e, r);
            });
          var r,
            n = { end: 0 };
          function i() {
          ...
          ve(t.scroller, "touchstart", function (i) {
                ...
                (o =
                  !n.prev || a(n, n.prev)
                    ...
                    : !n.prev.prev || a(n, n.prev.prev)
                      ? e.findWordAt(l)
                      : new Ni(ot(l.line, 0), ft(e.doc, ot(l.line + 1, 0)))),
            ...
            (t.dragFunctions = {
              ...
              start: function (t) {
                return (function (e, t) {
                  if (l && (!e.state.draggingText || +new Date() - Ro < 100))
                    Me(t);
                  else if (
                    !we(e, t) &&
                    !Tr(e.display, t) &&
          ...
          ve(u, "keyup", function (t) {
            ...
            ve(u, "keydown", oi(e, gl)),
            ve(u, "keypress", oi(e, ml)),
        ...
        (t.autofocus && !y) || this.hasFocus()
          ...
          : An(this),
        Ol))
          Ol.hasOwnProperty(u) && Ol[u](this, t[u], Ml);
        mi(this), t.finishInit && t.finishInit(this);
        for (var c = 0; c < Hl.length; ++c) Hl[c](this);
        Qn(this),
          a &&
            t.lineWrapping &&
      ...
      function Fl(e, t, r, n) {
        ...
        if (n || /\S/.test(s.text)) {
          if (
            "smart" == r &&
            ((u = o.mode.indent(i, s.text.slice(c.length), s.text)) == X ||
              u > 150)
          ) {
            if (!n) return;
            r = "prev";
        ...
        if ((f < u && (h += Q(u - f)), h != c))
          return (
            wo(o, h, ot(t, 0), ot(t, c.length), "+input"),
            (s.stateAfter = null),
            !0
          );
          ...
          if ("codepoint" == n) {
            ...
            l = i
              ? (function (e, t, r, n) {
                  ...
                  var s,
                    a = function (e, r) {
                      return nl(t, e instanceof ot ? e.ch : e, r);
                    },
                    u = function (r) {
      ...
      function $l(e, t, r) {
        ...
        if (t == e.display.lineDiv) {
          if (!(n = e.display.lineDiv.childNodes[r]))
            return Yl(e.clipPos(ot(e.display.viewTo - 1)), !0);
          (t = null), (r = 0);
        } else
        ...
        for (var i = 0; i < e.display.view.length; i++) {
          ...
          if (o.node == n) return _l(o, t, r);
        }
      }
      function _l(e, t, r) {
        var n = e.text.firstChild,
          i = !1;
        if (!t || !W(n, t)) return Yl(ot(tt(e.line), 0), !0);
        if (t == n && ((i = !0), (t = n.childNodes[r]), (r = 0), !t)) {
          var o = e.rest ? J(e.rest) : e.line;
          return Yl(ot(tt(o), o.text.length), i);
        }
        ...
        for (
          ...
          if ((h = c(f, f.firstChild, 0))) return Yl(ot(h.line, h.ch - d), i);
          d += f.textContent.length;
        }
        for (var p = s.previousSibling, g = r; p; p = p.previousSibling) {
          if ((h = c(p, p.firstChild, -1))) return Yl(ot(h.line, h.ch + g), i);
      ...
      (jl.prototype.init = function (e) {
        ...
        function l(e) {
          if (o(e) && !we(n, e)) {
            if (n.somethingSelected())
              El({ lineWise: !1, text: n.getSelections() }),
        ...
        (jl.prototype.showPrimarySelection = function () {
          ...
          if (
            ...
            var l = $l(t, e.anchorNode, e.anchorOffset),
              s = $l(t, e.focusNode, e.focusOffset);
            if (
              !l ||
              l.bad ||
              !s ||
              ...
              var a = t.display.view,
                u = (i.line >= t.display.viewFrom && Xl(t, i)) || {
                  node: a[0].measure.map[2],
                  offset: 0,
                },
                c = o.line < t.display.viewTo && Xl(t, o);
              if (!c) {
        ...
        (jl.prototype.pollSelection = function () {
          if (
            ...
            if (!this.composing) {
              this.rememberSelection();
              var r = $l(t, e.anchorNode, e.anchorOffset),
                n = $l(t, e.focusNode, e.focusOffset);
              r &&
                n &&
                ii(t, function () {
                  io(t.doc, Ai(r, n), Y),
      ...
      (ql.prototype.init = function (e) {
        ...
        (ql.prototype.createField = function (e) {
          ...
          Gl(this.textarea, t.spellcheck, t.autocorrect, t.autocapitalize);
        }),
            ...
            r("lineSeparator", null, function (e, t) {
              if (((e.doc.lineSep = t), t)) {
                ...
                for (var i = r.length - 1; i >= 0; i--)
                  wo(e.doc, t, r[i], ot(r[i].line, r[i].ch + t.length));
              }
            }),
            r(
              "specialChars",
        ...
        (function (e) {
          ...
          (e.prototype = {
            ...
            addKeyMap: function (e, t) {
              this.state.keyMaps[t ? "push" : "unshift"](tl(e));
            },
              ...
              for (
                ...
                if (i.empty())
                  ...
                  0 == o.ch &&
                    t.length == u.length &&
                    u[n].from().ch > 0 &&
                    to(this.doc, n, new Ni(o, u[n].to()), Y);
                }
              }
            }),
            ...
            addWidget: function (e, t, r, n, i) {
              var o,
                ...
                s,
                a = this.display,
                u = (e = Zr(this, ft(this.doc, e))).bottom,
                c = e.left;
              if (
            ...
            triggerOnKeyDown: li(gl),
            triggerOnKeyPress: li(ml),
            triggerOnKeyUp: vl,
            triggerOnMouseDown: li(xl),
            ...
            moveH: li(function (e, t) {
              ...
              this.extendSelectionsBy(function (n) {
                return r.display.shift || r.doc.extend || n.empty()
                  ? Vl(r.doc, n.head, e, t, r.options.rtlMoveVisually)
                  : e < 0
                    ? n.from()
                    : n.to();
              }, _);
      ...
      var Zl = "iter insert remove copy getEditor constructor".split(" ");
      for (var Ql in Eo.prototype)
        Eo.prototype.hasOwnProperty(Ql) &&
          j(Zl, Ql) < 0 &&
          (Wl.prototype[Ql] = (function (e) {
            return function () {
    ...
    "object" == typeof t && void 0 !== r
      ...
      : "function" == typeof n && n.amd
        ? n(o)
        : ((i = i || self).CodeMirror = o());
}); /*!node_modules/codemirror/mode/javascript/javascript.js*/
amis.define("4bcc961", function (e, t, r, n) {
  var a;
  (a = function (e) {
    "use strict";
    e.defineMode("javascript", function (t, r) {
      ...
      function k(e, t) {
        ...
        if ("#" == n && "!" == e.peek())
          return e.skipToEnd(), v("meta", "meta");
        ...
        if (((M.marked = "def"), u)) {
          if (t.context)
            if ("var" == t.lexical.info && t.context && t.context.block) {
              ...
              return void (t.localVars = new C(e, t.localVars));
          r.globalVars &&
            !E(e, t.globalVars) &&
            (t.globalVars = new C(e, t.globalVars));
        }
      }
      function I(e, t) {
        if (t) {
          ...
          return E(e, t.vars) ? t : new $(t.prev, new C(e, t.vars), !1);
        }
        return null;
      }
      function T(e) {
      ...
      var S = new C("this", new C("arguments", null));
      function _() {
      ...
      function G(e, t, r) {
        if (M.state.fatArrowAt == M.stream.start) {
          var n = r ? Y : X;
          if ("(" == e) return V(_, P(")"), oe(Pe, ")"), N, U("=>"), n, O);
          if ("variable" == e) return A(_, Ae, U("=>"), n, O);
        }
        var a = r ? L : K;
      ...
      function ae(e) {
        return "variable" != e ? A(ie) : ((M.marked = "property"), V(_e));
      }
      function ie(e) {
        return ":" == e ? V(H) : "(" == e ? A(_e) : void 0;
      }
      function oe(e, t, r) {
        function n(a, i) {
      ...
      function $e(e, t) {
        return "await" == t ? V($e) : "(" == e ? V(P(")"), Ce, N) : void 0;
      }
      function Ce(e) {
        return "var" == e ? V(Me, Se) : "variable" == e ? V(Se) : A(Se);
      }
      function Se(e, t) {
        return ")" == e
          ? V()
      ...
      function Fe(e, t) {
        ...
        return A(r && "interface" == r.info ? qe : _e);
      }
      function He(e, t) {
        return "*" == t
...
amis.define("a5ddd39", function (t, e, n, r) {
  var o;
  (o = function (t) {
    "use strict";
    var e = {
    ...
    t.defineMode("xml", function (r, o) {
      ...
      function f(t, e) {
        ...
        if (">" == o || ("/" == o && t.eat(">")))
          return (
            (e.tokenize = d),
            (a = ">" == o ? "endTag" : "selfcloseTag"),
            "tag bracket"
          );
        if ("=" == o) return (a = "equals"), null;
        if ("<" == o) {
          (e.tokenize = d), (e.state = k), (e.tagName = e.tagStart = null);
      ...
      function b(t, e) {
        for (var n; ; ) {
          ...
          if (
            ((n = t.context.tagName),
            !u.contextGrabbers.hasOwnProperty(p(n)) ||
              !u.contextGrabbers[p(n)].hasOwnProperty(p(e)))
          )
            return;
          x(t);
        }
      ...
      function w(t, e, n) {
        return "word" == t
          ? ((n.tagName = e.current()), (i = "tag"), y)
          : u.allowMissingTagName && "endTag" == t
            ? ((i = "tag bracket"), y(t, 0, n))
            : ((i = "error"), w);
      }
      function v(t, e, n) {
        if ("word" == t) {
          ...
          return (
            n.context &&
              n.context.tagName != r &&
              u.implicitlyClosed.hasOwnProperty(p(n.context.tagName)) &&
              x(n),
        ...
        return u.allowMissingTagName && "endTag" == t
          ? ((i = "tag bracket"), T(t, 0, n))
          : ((i = "error"), N);
      }
      function T(t, e, n) {
        return "endTag" != t ? ((i = "error"), T) : (x(n), k);
      }
      function N(t, e, n) {
        return (i = "error"), T(t, 0, n);
      }
      function y(t, e, n) {
        ...
        if ("endTag" == t || "selfcloseTag" == t) {
          ...
          return (
            ...
            "selfcloseTag" == t || u.autoSelfClosers.hasOwnProperty(p(r))
              ? b(n, r)
              : (b(n, r), (n.context = new h(n, r, o == n.indented))),
            k
          );
        }
        return (i = "error"), y;
      ...
      function C(t, e, n) {
        return "equals" == t
          ? z
          : (u.allowMissing || (i = "error"), y(t, 0, n));
      }
      function z(t, e, n) {
        return "string" == t
          ? M
          ...
          indent: function (e, n, r) {
            ...
            if (a && a[1])
              for (; o; ) {
                ...
                if (!u.implicitlyClosed.hasOwnProperty(p(o.tagName))) break;
                o = o.prev;
              }
            else if (a)
              for (; o; ) {
                var i = u.contextGrabbers[p(o.tagName)];
                if (!i || !i.hasOwnProperty(p(a[2]))) break;
                o = o.prev;
              }
            for (; o && o.prev && !o.startOfLine; ) o = o.prev;
            return o ? o.indent + l : e.baseIndent || 0;
          },
          electricInput: /<\/[\s\w:]+>$/,
...
amis.define("aa2c031", function (e, t, r, o) {
  var i;
  (i = function (e) {
    "use strict";
    function t(e) {
    ...
    e.defineMode("css", function (t, r) {
      ...
      var O = {
        ...
        maybeprop: function (e, t, r) {
          return ":" == e ? q(r, t, "prop") : B(e, t, r);
        },
        prop: function (e, t, r) {
          if (";" == e) return C(r);
          if ("{" == e && k) return q(r, t, "propBlock");
          if ("}" == e || "{" == e) return _(e, t, r);
        ...
        atBlock: function (e, t, r) {
          ...
          if ("}" == e || ";" == e) return _(e, t, r);
          if ("{" == e) return C(r) && q(r, t, k ? "block" : "top");
          if ("interpolation" == e) return q(r, t, "interpolation");
          if ("word" == e) {
            var o = t.current().toLowerCase();
            a =
            ...
            : "word" == e
              ? ((a =
                  ...
                  ("@counter-style" == r.stateArg &&
                    !b.hasOwnProperty(t.current().toLowerCase()))
                    ? "error"
                    : "property"),
                "maybeprop")
              : "restricted_atBlock";
      ...
      return {
        startState: function (e) {
          return {
            ...
            state: o ? "block" : "top",
            stateArg: null,
            context: new K(o ? "block" : "top", e || 0, null),
          };
        },
        token: function (e, t) {
            ...
            r.prev &&
              ...
              ("block" != r.type &&
                ...
                ? ((")" != o ||
                    ...
                    ("{" != o || ("at" != r.type && "atBlock" != r.type))) ||
                  (i = Math.max(0, r.indent - n))
                : (i = (r = r.prev).indent)),
            i
          );
        },
...
amis.define("3c309be", function (t, e, a, n) {
  var l;
  (l = function (t) {
    "use strict";
    var e = {
    ...
    function o(t, e) {
      for (var a in t)
        for (
          var n = e[a] || (e[a] = []), l = t[a], o = l.length - 1;
          o >= 0;
          o--
        )
          n.unshift(l[o]);
      ...
      function (a, c) {
        ...
        if ((o(e, r), s && o(s, r), u))
          for (var m = u.length - 1; m >= 0; m--)
            r.script.unshift(["type", u[m].matches, u[m].mode]);
        function d(e, o) {
          var c,
          ...
          if (
            u &&
            !/[<>\s\/]/.test(e.current()) &&
            (c = o.htmlState.tagName && o.htmlState.tagName.toLowerCase()) &&
            r.hasOwnProperty(c)
          )
            o.inTag = c + " ";
            ...
            var g =
                ...
                (function (t, e) {
                  for (var a = 0; a < t.length; a++) {
                    var l = t[a];
                    if (!l[0] || l[1].test(n(e, l[0]))) return l[2];
                  }
                })(r[m[1]], m[2]),
              f = t.getMode(a, g),
              p = l(m[1], !0),
                ...
                : (function (t, e, a) {
                    ...
                    return (
                      l > -1
                        ? t.backUp(n.length - l)
                        : n.match(/<\/?$/) &&
                          (t.backUp(n.length), t.match(e, !1) || t.match(n)),
                      a
                    );
                  })(t, h, e.localMode.token(t, e.localState));
            }),
              (o.localMode = f),
              (o.localState = t.startState(f, i.indent(o.htmlState, "", "")));
          } else
            o.inTag && ((o.inTag += e.current()), e.eol() && (o.inTag += " "));
          return s;
        }
        return {
          startState: function () {
          ...
          copyState: function (e) {
            var a;
            return (
              e.localState && (a = t.copyState(e.localMode, e.localState)),
              {
                token: e.token,
                inTag: e.inTag,
          ...
          indent: function (e, a, n) {
            return !e.localMode || /^\s*<\//.test(a)
              ? i.indent(e.htmlState, a, n)
              : e.localMode.indent
                ? e.localMode.indent(e.localState, a, n)
                : t.Pass;
          },
    ...
    "object" == typeof e && "object" == typeof a
      ? l(t("e874872"), t("a5ddd39"), t("4bcc961"), t("aa2c031"))
      : "function" == typeof n && n.amd
        ? n(
            [
              "../../lib/codemirror",
...
amis.define("baa1b3c", function (t, e, n, a) {
  var r;
  (r = function (t) {
    "use strict";
    function e(t, e) {
    ...
    function a(t, a) {
      (t.next || t.push) && e(a, t.next || t.push),
        (this.regex = n(t.regex)),
        (this.token = (function (t) {
          if (!t) return null;
          if (t.apply) return t;
          if ("string" == typeof t) return t.replace(/\./g, " ");
          for (var e = [], n = 0; n < t.length; n++)
            e.push(t[n] && t[n].replace(/\./g, " "));
          return e;
        })(t.token)),
        (this.data = t);
    }
    function r(t, e) {
      return function (n, a) {
        if (a.pending) {
          ...
          return (
            0 == a.pending.length && (a.pending = null),
            (n.pos += r.text.length),
            r.token
          );
        }
        if (a.local) {
          ...
          return (
            ...
            a.local.endScan &&
              (l = a.local.endScan.exec(n.current())) &&
              (n.pos = n.start + l.index),
            o
          );
        }
        for (var s = t[a.state], d = 0; d < s.length; d++) {
          var c = s[d],
          ...
          if (u) {
            c.data.next
              ? (a.state = c.data.next)
              : c.data.push
                ? ((a.stack || (a.stack = [])).push(a.state),
                  (a.state = c.data.push))
                : c.data.pop &&
                  a.stack &&
                  a.stack.length &&
                  (a.state = a.stack.pop()),
              c.data.mode && i(e, a, c.data.mode, c.token),
              c.data.indent && a.indent.push(n.indentation() + e.indentUnit),
              c.data.dedent && a.indent.pop();
            var p = c.token;
            if (
              (p && p.apply && (p = p(u)),
              u.length > 2 && c.token && "string" != typeof c.token)
            ) {
              for (var f = 2; f < u.length; f++)
                u[f] &&
                  (a.pending || (a.pending = [])).push({
                    text: u[f],
                    token: c.token[f - 1],
                  });
    ...
    function o(t, e) {
      ...
      for (var a in t)
        if (t.hasOwnProperty(a)) {
          if (!e.hasOwnProperty(a) || !o(t[a], e[a])) return !1;
          n++;
        }
      for (var a in e) e.hasOwnProperty(a) && n--;
      return 0 == n;
    }
    function i(e, a, r, i) {
      var l;
      if (r.persistent)
        for (var s = a.persistentStates; s && !l; s = s.next)
          (r.spec ? o(r.spec, s.spec) : r.mode == s.mode) && (l = s);
      var d = l ? l.mode : r.mode || t.getMode(e, r.spec),
        c = l ? l.state : t.startState(d);
      r.persistent &&
        !l &&
        (a.persistentStates = {
          mode: d,
    ...
    function l(e, n) {
      return function (a, r, o) {
        if (a.local && a.local.mode.indent)
          return a.local.mode.indent(a.localState, r, o);
        if (
          null == a.indent ||
          a.local ||
          (n.dontIndentStates &&
        ...
        t: for (;;) {
          for (var s = 0; s < l.length; s++) {
            ...
            if (d.data.dedent && !1 !== d.data.dedentIfLineStart) {
              ...
              if (c && c[0]) {
                i--,
                  (d.next || d.push) && (l = e[d.next || d.push]),
    ...
    (t.defineSimpleMode = function (e, n) {
      t.defineMode(e, function (e) {
        return t.simpleMode(e, n);
      });
    }),
      (t.simpleMode = function (n, o) {
        e(o, "start");
        var i = {},
          s = o.meta || {},
          d = !1;
        ...
        var g = {
          ...
          copyState: function (e) {
            ...
            e.localState &&
              (n.localState = t.copyState(e.local.mode, e.localState)),
              e.stack && (n.stack = e.stack.slice(0));
            for (var a = e.persistentStates; a; a = a.next)
              n.persistentStates = {
                mode: a.mode,
                spec: a.spec,
                state:
                  a.state == e.localState
                    ? n.localState
                    : t.copyState(a.mode, a.state),
          ...
          token: r(i, n),
          innerMode: function (t) {
            return t.local && { mode: t.local.mode, state: t.localState };
          },
          indent: l(i, s),
        };
...
amis.define("8bd9ba0", function (e, n, t, r) {
  var i;
  (i = function (e) {
    "use strict";
    e.multiplexingMode = function (n) {
      ...
      return {
        ...
        token: function (i, o) {
          if (o.innerActive) {
            var c = o.innerActive;
            if (((a = i.string), !c.close && i.sol()))
              return (o.innerActive = o.inner = null), this.token(i, o);
            if (
              (v =
                c.close && !o.startingInner
                  ? r(a, c.close, i.pos, c.parseDelimiters)
                  : -1) == i.pos &&
              !c.parseDelimiters
            )
              return (
                ...
                c.delimStyle && c.delimStyle + " " + c.delimStyle + "-close"
              );
            v > -1 && (i.string = a.slice(0, v));
            var l = c.mode.token(i, o.inner);
            return (
              v > -1
                ? (i.string = a)
                : i.pos > i.start && (o.startingInner = !1),
              v == i.pos &&
                c.parseDelimiters &&
                (o.innerActive = o.inner = null),
              c.innerStyle && (l = l ? l + " " + c.innerStyle : c.innerStyle),
              l
            );
          }
          for (var s = 1 / 0, a = i.string, u = 0; u < t.length; ++u) {
            ...
            if ((v = r(a, d.open, i.pos)) == i.pos) {
              d.parseDelimiters || i.match(d.open),
                (o.startingInner = !!d.parseDelimiters),
                (o.innerActive = d);
              var f = 0;
              if (n.indent) {
        ...
        indent: function (t, r, i) {
          ...
          return o.indent
            ? o.indent(t.innerActive ? t.inner : t.outer, r, i)
            : e.Pass;
        },
...
amis.define("fa32337", function (e, t, o, n) {
  var r;
  (r = function (e) {
    function t(e) {
      e.state.placeholder &&
    ...
    function o(e) {
      ...
      (o.style.cssText = "height: 0; overflow: visible"),
        (o.style.direction = e.getOption("direction")),
        (o.className = "CodeMirror-placeholder CodeMirror-line-like");
      var n = e.getOption("placeholder");
      "string" == typeof n && (n = document.createTextNode(n)),
        o.appendChild(n),
        e.display.lineSpace.insertBefore(o, e.display.lineSpace.firstChild);
    }
    function n(e) {
      i(e) && o(e);
    }
    function r(e) {
      var n = e.getWrapperElement(),
        r = i(e);
      (n.className =
        n.className.replace(" CodeMirror-empty", "") +
        (r ? " CodeMirror-empty" : "")),
        r ? o(e) : t(e);
    }
    function i(e) {
    ...
    e.defineOption("placeholder", "", function (i, a, l) {
      var c = l && l != e.Init;
      if (a && !c)
        i.on("blur", n),
          i.on("change", r),
        ...
        i.off("blur", n),
          ...
          t(i);
        var p = i.getWrapperElement();
        p.className = p.className.replace(" CodeMirror-empty", "");
      }
      a && !i.hasFocus() && n(i);
    });
  }),
