...
amis.define("92a5388", function (e, t, n, a) {
  var r, o;
  (r = this),
    (o = function (e) {
      return (function (e) {
            ...
            v = (0, f.default)(
              ...
              function (e) {
                var t,
                  n = (0, o.default)(e, 3);
                return [
                  ((t = n[0]), t < 0.25 ? 1 : t < 0.5 ? 0.9 - t : 1.1 - t),
                  n[1],
                  n[2],
                ];
              },
        ...
        function (e, t, n) {
          ...
          var a = n(3),
            ...
            Z = function (e, t) {
              if (
                ((e = j(e)), (t = x(t, !0)), e !== V || !r(T, t) || r(q, t))
              ) {
                var n = M(e, t);
                return (
                  !n || !r(T, t) || (r(e, L) && e[L][t]) || (n.enumerable = !0),
                  n
                );
              }
            },
        ...
        function (e, t, n) {
          ...
          e.exports = n(1).isIterable = function (e) {
            var t = Object(e);
            return (
              void 0 !== t[r] || "@@iterator" in t || o.hasOwnProperty(a(t))
            );
          };
        },
        function (e, t, n) {
        ...
        function (e, t, n) {
          (function (t) {
            ...
            var E,
              ...
              D = Math.min,
              I =
                ((j = V(Object, "defineProperty")),
                (x = V.name) && x.length > 2 ? j : void 0);
            function R(e) {
              return $(e) ? P(e) : {};
            }
            function L(e, t, n, a) {
            ...
            function z(e, t, n, a, r, o, i, s, c, l) {
              var u = 128 & t,
                f = 1 & t,
                p = 2 & t,
                d = 24 & t,
                ...
                v = p ? void 0 : N(e);
              return function m() {
                for (var E = arguments.length, j = Array(E), x = E; x--; )
                  j[x] = arguments[x];
                if (d)
                  var _ = q(m),
                    k = y(j, _);
                if (
                  ...
                  var O = g(j, _);
                  return T(e, t, z, m.placeholder, n, j, O, s, c, l - E);
                }
                var C = f ? n : this,
                  S = p ? C[e] : e;
                return (
                  (E = j.length),
                  s ? (j = U(j, s)) : b && E > 1 && j.reverse(),
                  u && c < E && (j.length = c),
                  this && this !== h && this instanceof m && (S = v || N(S)),
                  S.apply(C, j)
                );
              };
            }
            function T(e, t, n, a, r, o, i, s, c, l) {
              var u = 8 & t;
              ...
              return (f.placeholder = a), G(f, e, t);
            }
            function q(e) {
            ...
            function Y(e, t, n) {
              var a = (function (e, t, n, a, r, o, i, s) {
                ...
                if (
                  ...
                  (r = p[4]),
                  !(s = p[9] =
                    null == p[9] ? (c ? 0 : e.length) : F(p[9] - l, 0)) &&
                    24 & t &&
                    (t &= -25),
                  t && 1 != t)
                )
                  ...
                  var d = (function (e, t, n) {
                    ...
                    return function t() {
                      return (
                        this && this !== h && this instanceof t ? r : e
              ...
              return (a.placeholder = Y.placeholder), a;
            }
            function $(e) {
              var t = typeof e;
              ...
              y =
                ...
                function () {
                  for (
                    ...
                    a[t] = e[v + t];
                  t = -1;
                  for (var r = Array(v + 1); ++t < v; ) r[t] = e[t];
                  return (r[v] = a), o(h, this, r);
                });
            e.exports = y;
          }).call(this, n(43));
        },
                    ...
                    style: o(
                      {
                        ...
                        ":hover": {
                          ...
                          borderLeft:
                            C.keyValBorderHover + " " + t.objectBorder,
                        },
                      },
                      n,
                    ),
          ...
          var $ = v.useLayoutEffect,
            ...
            X = function (e) {
              Object.keys(Z).forEach(function (t) {
                e.style.setProperty(t, Z[t], "important");
              });
            },
            ee = null,
            te = function () {},
            ...
            ae = !!document.documentElement.currentStyle,
            re = Object(v.forwardRef)(function (e, t) {
              var n,
          ...
          function oe(e) {
            ...
            try {
              if ("[" === (e = JSON.stringify(JSON.parse(e)))[0])
                return ie("array", JSON.parse(e));
              if ("{" === e[0]) return ie("object", JSON.parse(e));
              if (e.match(/\-?\d+\.\d+/) && e.match(/\-?\d+\.\d+/)[0] === e)
                return ie("float", parseFloat(e));
              if (e.match(/\-?\d+e-\d+/) && e.match(/\-?\d+e-\d+/)[0] === e)
                return ie("float", Number(e));
              if (e.match(/\-?\d+/) && e.match(/\-?\d+/)[0] === e)
                return ie("integer", parseInt(e));
              if (e.match(/\-?\d+e\+\d+/) && e.match(/\-?\d+e\+\d+/)[0] === e)
                return ie("integer", Number(e));
            } catch (e) {}
            switch ((e = e.toLowerCase())) {
              case "undefined":
                return ie("undefined", void 0);
              case "nan":
                return ie("nan", NaN);
              case "null":
                return ie("null", null);
              ...
              case "false":
                return ie("boolean", !1);
              default:
                if ((e = Date.parse(e))) return ie("date", new Date(e));
            }
            return ie(!1, null);
          }
          function ie(e, t) {
                ...
                return (
                  ...
                  (a.showDetected = function () {
                    var e = a.props,
                      t = e.theme,
                      n =
                        (e.variable, e.namespace, e.rjvId, a.state.parsedInput),
                ...
                c(n, [
                  {
                    ...
                    value: function (e) {
                      ...
                      return this.state.expanded[e]
                        ? m.a.createElement(ke, { theme: n, iconStyle: a })
                        : m.a.createElement(Oe, { theme: n, iconStyle: a });
                    },
                  },
                  {
                    key: "render",
                    value: function () {
                      ...
                      return m.a.createElement(
                        ...
                        m.a.createElement(_e, this.props),
                        m.a.createElement(
                          "span",
                          null,
                          m.a.createElement(
            ...
            Me = (function (e) {
              ...
              function n() {
                ...
                for (
                  ...
                  r[o] = arguments[o];
                return (
                  ((e = t.call.apply(t, [this].concat(r))).render =
                    function () {
                      var t = d(e).props,
                        n = [t.name],
                        a = Ae;
            ...
            Fe = (function (e) {
              ...
              function n() {
                ...
                for (
                  ...
                  r[s] = arguments[s];
                return (
                  ((e = t.call.apply(t, [this].concat(r))).isValid = function (
                    t,
                  ) {
                    var n = e.props.rjvId,
    ...
    "object" == typeof t && "object" == typeof n
      ? (n.exports = o(e("8d5e11f")))
      : "function" == typeof a && a.amd
        ? a(["react"], o)
        : "object" == typeof t
          ? (t.reactJsonView = o(e("8d5e11f")))
          : (r.reactJsonView = o(r.React));
});
