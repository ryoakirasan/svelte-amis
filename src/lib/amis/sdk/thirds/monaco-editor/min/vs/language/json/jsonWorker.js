...
!(function (e) {
  ...
  (function (e) {
    ...
    function o(e, t, n, o) {
      ...
      if (u) {
        if (
          ...
          if (void 0 === n) return [];
          var m = JSON.stringify(f) + ": " + JSON.stringify(n),
            g = void 0;
          return i(
            e,
            (g =
              (j = o.getInsertionIndex
                ? o.getInsertionIndex(
        ...
        if (
          ...
          if (-1 === v) {
            ...
            if (0 === u.children.length)
              ...
              g = {
                offset:
                  (C = u.children[u.children.length - 1]).offset + C.length,
                length: 0,
                content: "," + m,
              };
            return i(e, g, o);
          ...
          if (void 0 !== n) {
            ...
            if (!o.isArrayInsertion && u.children.length > f) {
              ...
              var C,
                j = f > u.children.length ? u.children.length : f;
              g = {
                offset: (C = u.children[j - 1]).offset + C.length,
                length: 0,
                content: "," + m,
    ...
    function i(e, t, r) {
      ...
      for (
        var c = n.format(o, { offset: i, length: s - i }, r.formattingOptions),
          u = c.length - 1;
        u >= 0;
        u--
      ) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (function (e) {
        (e.create = function (e, t, n, o) {
          if (k.uinteger(e) && k.uinteger(t) && k.uinteger(n) && k.uinteger(o))
      ...
      (function (e) {
        (e.create = function (e, t, n, r, o) {
          ...
          return (
            k.defined(n) && (i.startCharacter = n),
        ...
        (e.create = function (e, t, n, r, o, i) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (k.integer(n.code) || k.string(n.code) || k.undefined(n.code)) &&
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              k.defined(t) && b.is(t.textDocument) && Array.isArray(t.edits)
            );
          });
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              t && k.string(t.newText) && o.is(t.insert) && o.is(t.replace)
            );
          });
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              t &&
              k.string(t.title) &&
              (void 0 === t.diagnostics || k.typedArray(t.diagnostics, c.is)) &&
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              k.defined(t) && k.uinteger(t.tabSize) && k.boolean(t.insertSpaces)
            );
          });
        ...
        for (var r = 0, a = t; r < a.length; r++) {
          ...
          if (e.isIncremental(s)) {
            ...
            if (d - l === h.length)
              ...
              h.length < 1e4
                ? p.splice.apply(p, __spreadArray([l + 1, d - l], h, !1))
                : (this._lineOffsets = p =
...
!(function (e) {
  ...
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.parse =
      ...
      t.asSchema =
      t.ObjectASTNodeImpl =
      t.PropertyASTNodeImpl =
      t.StringASTNodeImpl =
      t.NumberASTNodeImpl =
      t.ArrayASTNodeImpl =
      t.BooleanASTNodeImpl =
      t.NullASTNodeImpl =
      t.ASTNodeImpl =
        void 0);
  ...
  var v = (function () {
      ...
      return (
        ...
        (e.prototype.include = function (e) {
          return (
            (-1 === this.focusOffset || S(e, this.focusOffset)) &&
            e !== this.exclude
          );
        }),
        ...
        (e.prototype.mergeEnumValues = function (e) {
          if (
            ...
            for (var t = 0, n = this.problems; t < n.length; t++) {
              var r = n[t];
              r.code === i.ErrorCode.EnumValueMismatch &&
                (r.message = a(
                  "enumWarning",
  ...
  (t.ValidationResult = b),
    (t.newJSONDocument = function (e, t) {
      return void 0 === t && (t = []), new C(e, t, []);
    }),
    (t.getNodeValue = x),
  ...
  var C = (function () {
    ...
    return (
      ...
      (e.prototype.validate = function (e, t, n) {
        if (
          (void 0 === n && (n = i.DiagnosticSeverity.Warning), this.root && t)
        ) {
          var r = new b();
          return (
            j(this.root, t, r, y.instance),
      ...
      (e.prototype.getMatchingSchemas = function (e, t, n) {
        void 0 === t && (t = -1);
        var r = new v(t, n);
        return this.root && e && j(this.root, e, new b(), r), r.schemas;
      }),
      e
    );
  })();
    ...
    if (e && c.include(e)) {
      ...
      switch (u.type) {
        case "object":
          !(function (e, t, n, i) {
            for (
              ...
              (s[(J = (C = f[u]).keyNode.value)] = C.valueNode), c.push(J);
            }
            if (Array.isArray(t.required))
              for (var l = 0, d = t.required; l < d.length; l++) {
                if (!s[(w = d[l])]) {
                  var p =
                      e.parent &&
            ...
            if (t.properties)
              for (
                var v = 0, x = Object.keys(t.properties);
                v < x.length;
                v++
              ) {
                m((w = x[v]));
                var S = t.properties[w];
                if ((R = s[w]))
                  if (r.isBoolean(S))
                  ...
                  else j(R, S, (N = new b()), i), n.mergePropertyMatch(N);
              }
            if (t.patternProperties)
              for (
                var A = 0, T = Object.keys(t.patternProperties);
                A < T.length;
                A++
              )
                for (
                  var k = T[A], O = o.extendedRegExp(k), I = 0, E = c.slice(0);
                  I < E.length;
                  I++
                ) {
                  var w = E[I];
            ...
            if ("object" == typeof t.additionalProperties)
              for (var P = 0, _ = c; P < _.length; P++) {
                if ((R = s[(w = _[P])])) {
                  var N = new b();
                  j(R, t.additionalProperties, N, i), n.mergePropertyMatch(N);
                }
              }
            ...
            if (t.dependencies)
              for (
                var F = 0, L = Object.keys(t.dependencies);
                F < L.length;
                F++
              ) {
                if (s[(J = L[F])]) {
                  ...
                  if (Array.isArray(V))
                    ...
                    j(e, S, (N = new b()), i), n.mergePropertyMatch(N);
                }
              }
            var K = g(t.propertyNames);
            if (K)
              for (var W = 0, B = e.properties; W < B.length; W++) {
                var J;
                (J = B[W].keyNode) && j(J, K, n, y.instance);
              }
          })(u, t, n, c);
          break;
        case "array":
            ...
            if (Array.isArray(t.items)) {
              ...
              if (l)
                for (var d = 0, p = e.items; d < p.length; d++) {
                  var h;
                  j((h = p[d]), l, (u = new b()), o), n.mergePropertyMatch(u);
                }
            }
            var m = g(t.contains);
            if (m) {
              var v = e.items.some(function (e) {
                var t = new b();
                return j(e, m, t, y.instance), !t.hasProblems();
              });
              v ||
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
        ...
        case "string":
          !(function (e, t, n, i) {
            ...
            if (r.isString(t.pattern)) {
              o.extendedRegExp(t.pattern).test(e.value) ||
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message:
                ...
                case "uri-reference":
                  ...
                  if (e.value) {
                    ...
                    u
                      ...
                      : (c = a("uriMissing", "URI is expected."));
                  ...
                  c &&
                    n.problems.push({
                      ...
                      message:
                        t.patternErrorMessage ||
                        t.errorMessage ||
                        a("uriFormatWarning", "String is not a URI: {0}", c),
                    });
                  break;
                case "color-hex":
                case "date-time":
        ...
        case "number":
          ...
          break;
        case "property":
          return j(u.valueNode, t, n, c);
      }
      !(function () {
        function e(e) {
          return (
            u.type === e ||
            ("integer" === e && "number" === u.type && u.isInteger)
          );
        }
        ...
        var y = function (e, t) {
          for (var r = [], o = void 0, i = 0, s = e; i < s.length; i++) {
            var f = g(s[i]),
              l = new b(),
              d = c.newSub();
            if ((j(u, f, l, d), l.hasProblems() || r.push(f), o))
          ...
          return (
            r.length > 1 &&
              t &&
              n.problems.push({
                location: { offset: u.offset, length: 1 },
                message: a(
                  "oneOfWarning",
        ...
        C &&
          (function (e, t, n) {
            var r = g(e),
              o = new b(),
              i = c.newSub();
            j(u, r, o, i), c.merge(i), o.hasProblems() ? n && S(n) : t && S(t);
          })(C, g(t.then), g(t.else));
        if (Array.isArray(t.enum)) {
          for (var A = x(u), T = !1, k = 0, O = t.enum; k < O.length; k++) {
            var I = O[k];
            if (r.equals(A, I)) {
              T = !0;
              break;
  ...
  (t.JSONDocument = C),
    (t.parse = function (e, t) {
      ...
      function b(t, n, r, a, c) {
        if (
          (void 0 === c && (c = i.DiagnosticSeverity.Error),
          0 === o.length || r !== s)
        ) {
      ...
      function S() {
        switch (g.getTokenError()) {
          case 4:
            return (
              x(
                a("InvalidUnicode", "Invalid unicode sequence in string."),
                i.ErrorCode.InvalidUnicode,
              ),
              !0
            );
          case 5:
            return (
              x(
                ...
                i.ErrorCode.InvalidEscapeCharacter,
              ),
              !0
            );
          case 3:
            return (
              x(
                a("UnexpectedEndOfNumber", "Unexpected end of number."),
                i.ErrorCode.UnexpectedEndOfNumber,
              ),
              !0
            );
          case 1:
            return (
              x(
                a("UnexpectedEndOfComment", "Unexpected end of comment."),
                i.ErrorCode.UnexpectedEndOfComment,
              ),
              !0
            );
          case 2:
            return (
              x(
                a("UnexpectedEndOfString", "Unexpected end of string."),
                i.ErrorCode.UnexpectedEndOfString,
              ),
              !0
            );
          case 6:
      ...
      function T(t, n) {
        ...
        if (!o) {
          ...
          x(
            a("DoubleQuotesExpected", "Property keys must be doublequoted"),
        ...
        if (
          (c
            ? (b(
                a("DuplicateKeyWarning", "Duplicate object key"),
                i.ErrorCode.DuplicateKey,
                r.keyNode.offset,
                r.keyNode.offset + r.keyNode.length,
                i.DiagnosticSeverity.Warning,
              ),
              "object" == typeof c &&
                b(
                  a("DuplicateKeyWarning", "Duplicate object key"),
          ...
          (x(a("ColonExpected", "Colon expected"), i.ErrorCode.ColonExpected),
          10 === g.getToken() &&
        ...
        return u
          ...
          : x(
              a("ValueExpected", "Value expected"),
              i.ErrorCode.ValueExpected,
              r,
              [],
              [2, 5],
            );
      ...
      function O(e) {
        return (
            ...
            if (3 === g.getToken()) {
              ...
              for (var n = !1; 4 !== g.getToken() && 17 !== g.getToken(); ) {
                if (5 === g.getToken()) {
                  ...
                  if ((y(), 4 === g.getToken())) {
                    n &&
                      b(
                        a("TrailingComma", "Trailing comma"),
                        i.ErrorCode.TrailingComma,
                        r,
                        r + 1,
                      );
                    continue;
                  ...
                  n &&
                    x(
                      a("ExpectedComma", "Expected comma"),
                      i.ErrorCode.CommaExpected,
                    );
                var o = O(t);
                o
                  ? t.items.push(o)
                  : x(
                      a("PropertyExpected", "Value expected"),
                      i.ErrorCode.ValueExpected,
                      void 0,
                      [],
                      [4, 5],
              ...
              return 4 !== g.getToken()
                ? x(
                    ...
                    i.ErrorCode.CommaOrCloseBacketExpected,
                    t,
                  )
                : j(t, !0);
            }
            ...
            if (1 === g.getToken()) {
              ...
              for (var r = !1; 2 !== g.getToken() && 17 !== g.getToken(); ) {
                if (5 === g.getToken()) {
                  r ||
                    x(
                      a("PropertyExpected", "Property expected"),
                      i.ErrorCode.PropertyExpected,
                    );
              ...
              return 2 !== g.getToken()
                ? x(
                    a("ExpectedCloseBrace", "Expected comma or closing brace"),
                    i.ErrorCode.CommaOrCloseBraceExpected,
                    t,
                  )
                : j(t, !0);
            }
            ...
            if (11 === g.getToken()) {
              ...
              if (0 === g.getTokenError()) {
                ...
                try {
                  ...
                  if (!r.isNumber(o))
                    return x(
                      a("InvalidNumberFormat", "Invalid number format."),
                      i.ErrorCode.Undefined,
                      t,
                    );
                  t.value = o;
          ...
          (function (e) {
            switch (g.getToken()) {
              case 7:
                return j(new u(e, g.getTokenOffset()), !0);
              case 8:
                return j(new f(e, !0, g.getTokenOffset()), !0);
              case 9:
                return j(new f(e, !1, g.getTokenOffset()), !0);
              default:
                return;
            }
          })(e)
      ...
      return (
        17 !== y() &&
          ((I = O(I))
            ? 17 !== g.getToken() &&
              x(
                a("End of file expected", "End of file expected."),
                i.ErrorCode.Undefined,
              )
            : x(
                a(
              ...
              if (n && (void 0 !== u || "array" === n.type)) {
                for (
                  var d = this.evaluateSeparatorAfter(o, c),
                    p = 0,
                    h = t.getMatchingSchemas(e.schema, n.offset, f);
                  p < h.length;
                  p++
                ) {
                  var m = h[p];
                  if (m.node === n && !m.inverted && m.schema) {
                    if ("array" === n.type && m.schema.items)
                      if (Array.isArray(m.schema.items)) {
                        ...
                        this.addSchemaValueCompletions(m.schema.items, d, a, s);
                    if (void 0 !== u) {
                      var v = !1;
                      if (m.schema.properties)
                        (S = m.schema.properties[u]) &&
                          ((v = !0),
                          this.addSchemaValueCompletions(S, d, a, s));
                      if (m.schema.patternProperties && !v)
                        for (
                          var y = 0,
                            b = Object.keys(m.schema.patternProperties);
                          y < b.length;
                          y++
                        ) {
                          var x = b[y];
                          if (i.extendedRegExp(x).test(u)) {
                            v = !0;
                            var S = m.schema.patternProperties[x];
                            this.addSchemaValueCompletions(S, d, a, s);
                          }
                        }
                      if (m.schema.additionalProperties && !v) {
                        S = m.schema.additionalProperties;
                        this.addSchemaValueCompletions(S, d, a, s);
                      }
                    }
                  }
          ...
          470: (e) => {
            ...
            var r = {
              ...
              relative: function (e, n) {
                ...
                for (
                  var c = n.length - s, u = a < c ? a : c, f = -1, l = 0;
                  l <= u;
                  ++l
                ) {
                  if (l === u) {
                    if (c > u) {
                      if (47 === n.charCodeAt(s + l)) return n.slice(s + l + 1);
                ...
                return (
                  ...
                  (e.prototype.with = function (e) {
                    ...
                    return (
                      ...
                      void 0 === o ? (o = this.query) : null === o && (o = f),
                      void 0 === i
                        ? (i = this.fragment)
                        : null === i && (i = f),
                      t === this.scheme &&
  ...
  (function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define(
          "vscode-json-languageservice/utils/glob",
          ["require", "exports"],
          e,
        );
  })(function (e, t) {
      ...
      f = (function () {
        function e(e, t, n) {
          (this.service = e),
            ...
            (this.dependencies = {}),
            n &&
              (this.unresolvedSchema = this.service.promise.resolve(new l(n)));
        }
        return (
      ...
      return (
        ...
        (e.prototype.resolveSchemaContent = function (e, t, n) {
          ...
          var s = this.contextService,
            u = function (e, t, n, r) {
              ...
              if (a)
                for (var s in a)
                  a.hasOwnProperty(s) && !e.hasOwnProperty(s) && (e[s] = a[s]);
              else
                o.push(
                  c(
            ...
            f = function (e, t, n, i, a) {
              ...
              return f.getUnresolvedSchema().then(function (r) {
                ...
                return u(e, r.schema, t, n), l(e, r.schema, t, f.dependencies);
              });
            },
            l = function (e, t, n, o) {
          ...
          return l(i, i, t, n).then(function (e) {
            return new d(i, o);
          });
        }),
        (e.prototype.getSchemaForResource = function (e, t) {
          ...
          for (
            var u = Object.create(null),
              ...
              d = 0,
              p = this.filePatternAssociations;
            d < p.length;
            d++
          ) {
            var h = p[d];
          ...
          return (
            (this.cachedSchemaForResource = { resource: e, resolvedSchema: b }),
            b
          );
        }),
        ...
        (e.prototype.getMatchingSchemas = function (e, t, n) {
          if (n) {
            ...
            return this.resolveSchemaContent(new l(n), r, {}).then(
              function (e) {
        ...
        return (
          ...
          (e.prototype.doValidation = function (e, t, o, i) {
            ...
            var d = [],
              ...
              m = function (n) {
                var i = (null == o ? void 0 : o.trailingCommas)
                    ? l(o.trailingCommas)
                    : r.DiagnosticSeverity.Error,
                  c = (null == o ? void 0 : o.comments)
                    ? l(o.comments)
                    : s.commentSeverity,
            ...
            if (i) {
              ...
              return this.jsonSchemaService
                .resolveSchemaContent(new n.UnresolvedSchema(i), g, {})
                .then(function (e) {
                  return m(e);
                });
            }
  ...
  (function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define(
          "vscode-json-languageservice/services/jsonLinks",
              ...
              return (function (e, t) {
                ...
                return (function (e) {
                  for (var t = [], n = 1; n < arguments.length; n++)
                    t[n - 1] = arguments[n];
                  for (
                    var o = r.URI.parse(e), i = o.path.split("/"), a = 0, s = t;
                    a < s.length;
                    a++
                  ) {
                    var u = s[a];
