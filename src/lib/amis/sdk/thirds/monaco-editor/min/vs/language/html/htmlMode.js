...
define(
      ...
      return (
        ...
        (e.prototype.getLanguageServiceWorker = function () {
          ...
          return this._getClient()
            ...
            .then(function (e) {
              if (n._worker) return n._worker.withSyncedResources(t);
            })
            .then(function (n) {
              return e;
            });
  ...
  (function (e) {
    ...
    "use strict";
    var t, i, r, o, a, u, s, c, d, g, l, f, m, h, p, v, y;
    Object.defineProperty(n, "__esModule", { value: !0 }),
      (n.TextDocument =
        n.EOL =
        n.SelectionRange =
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (A.undefined(t.relatedInformation) ||
                A.typedArray(t.relatedInformation, u.is))
            );
          });
      })((s = n.Diagnostic || (n.Diagnostic = {}))),
      (function (e) {
        (e.create = function (e, n) {
      ...
      })((m = n.TextDocumentEdit || (n.TextDocumentEdit = {}))),
      (function (e) {
        (e.create = function (e, n, t) {
            ...
            if (C.is(e)) {
              ...
              if (!(i = this._textEditChanges[n.uri])) {
                ...
                this._workspaceEdit.documentChanges.push(t),
                  (i = new w(r, this._changeAnnotations)),
    ...
    (n.WorkspaceChange = x),
      ...
      (function (e) {
        e.is = function (e) {
          var n = e;
          return A.objectLiteral(e) && b.is(n.kind) && A.string(n.value);
        };
      })((k = n.MarkupContent || (n.MarkupContent = {}))),
      (function (e) {
        (e.Text = 1),
          (e.Method = 2),
          (e.Function = 3),
      ...
      (function (e) {
        (e.create = function (e, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              A.defined(n) &&
              A.typedArray(n.diagnostics, s.is) &&
        ...
        (e.create = function (e, n, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              n &&
              A.string(n.title) &&
              (void 0 === n.diagnostics || A.typedArray(n.diagnostics, s.is)) &&
      ...
      (function (e) {
        function n(e, t) {
          ...
          var i = (e.length / 2) | 0,
            ...
            o = e.slice(i);
          n(r, t), n(o, t);
          for (var a = 0, u = 0, s = 0; a < r.length && u < o.length; ) {
            var c = t(r[a], o[u]);
            e[s++] = c <= 0 ? r[a++] : o[u++];
          }
          for (; a < r.length; ) e[s++] = r[a++];
          for (; u < o.length; ) e[s++] = o[u++];
          return e;
        }
        (e.create = function (e, n, t, i) {
          ...
          (e.applyEdits = function (e, t) {
            for (
              ...
              var u = r[a],
                s = e.offsetAt(u.range.start),
                c = e.offsetAt(u.range.end);
              if (!(c <= o)) throw new Error("Overlapping edit");
              (i = i.substring(0, s) + u.newText + i.substring(c, i.length)),
                (o = s);
            }
            return i;
          });
  ...
  define(
    ...
    function (e, n, t, i) {
      ...
      function u(e) {
        if (e) return { range: o(e.range), text: e.newText };
      }
      Object.defineProperty(n, "__esModule", { value: !0 }),
        (n.SelectionRangeAdapter =
          ...
          n.DocumentFormattingEditProvider =
          n.DocumentLinkAdapter =
      ...
      var s = (function () {
        ...
        return (
          ...
          (e.prototype.provideCompletionItems = function (e, n, s, c) {
            var d = e.uri;
            return this._worker(d)
              .then(function (e) {
                return e.doComplete(d.toString(), r(n));
              })
              .then(function (r) {
                if (r) {
                  var s = e.getWordUntilPosition(n),
                    c = new i.Range(
                      n.lineNumber,
                      s.startColumn,
                      n.lineNumber,
                    ...
                    d = r.items.map(function (e) {
                      ...
                      return (
                        e.textEdit &&
                          ...
                          void 0 !== r.replace
                            ? (s.range = {
                                insert: o(e.textEdit.insert),
                                replace: o(e.textEdit.replace),
                              })
                            : (s.range = o(e.textEdit.range)),
                          (s.insertText = e.textEdit.newText)),
        ...
        return (
          (e.prototype.provideHover = function (e, n, t) {
            ...
            return this._worker(i)
              .then(function (e) {
                return e.doHover(i.toString(), r(n));
              })
              .then(function (e) {
                if (e) return { range: o(e.range), contents: d(e.contents) };
              });
          }),
          e
        );
      ...
      function l(e) {
        var n = i.languages.DocumentHighlightKind;
        switch (e) {
      ...
      var f = (function () {
        ...
        return (
          (e.prototype.provideDocumentHighlights = function (e, n, t) {
            ...
            return this._worker(i)
              .then(function (e) {
                return e.findDocumentHighlights(i.toString(), r(n));
              })
              .then(function (e) {
                if (e)
                  return e.map(function (e) {
                    return { range: o(e.range), kind: l(e.kind) };
                  });
              });
          }),
          e
                ...
                if (e)
                  return e.map(function (e) {
                    return {
                      ...
                      kind: m(e.kind),
                      tags: [],
                      range: o(e.location.range),
                      selectionRange: o(e.location.range),
                    };
                  });
              });
          }),
      ...
      var p = (function () {
        ...
        return (
          (e.prototype.provideLinks = function (e, n) {
            var t = e.uri;
            return this._worker(t)
              .then(function (e) {
                return e.findDocumentLinks(t.toString());
              })
              .then(function (e) {
                if (e)
                  return {
                    links: e.map(function (e) {
                      return { range: o(e.range), url: e.target };
                    }),
                  };
              });
          }),
        ...
        return (
          (e.prototype.provideDocumentFormattingEdits = function (e, n, t) {
            ...
            return this._worker(i).then(function (e) {
              return e.format(i.toString(), null, v(n)).then(function (e) {
      ...
      n.DocumentFormattingEditProvider = y;
      var C = (function () {
        function e(e) {
          this._worker = e;
        }
      ...
      n.DocumentRangeFormattingEditProvider = C;
      var b = (function () {
        function e(e) {
          this._worker = e;
        }
        return (
          (e.prototype.provideRenameEdits = function (e, n, t, a) {
            var u = e.uri;
            return this._worker(u)
              .then(function (e) {
                return e.doRename(u.toString(), r(n), t);
              })
              .then(function (e) {
                return (function (e) {
                  ...
                  for (var t in e.changes)
                    for (
                      var r = i.Uri.parse(t), a = 0, u = e.changes[t];
                      a < u.length;
                      a++
                    ) {
                      var s = u[a];
                      n.push({
                        resource: r,
                        edit: { range: o(s.range), text: s.newText },
                      });
                    }
                  return { edits: n };
                })(e);
      ...
      var I = (function () {
        ...
        return (
          (e.prototype.provideSelectionRanges = function (e, n, t) {
            ...
            return this._worker(i)
              .then(function (e) {
                return e.getSelectionRanges(i.toString(), n.map(r));
              })
              .then(function (e) {
                if (e)
                  return e.map(function (e) {
                    for (var n = []; e; )
                      n.push({ range: o(e.range) }), (e = e.parent);
                    return n;
                  });
              });
          }),
  ...
  define(
    ...
    function (e, n, t, i, r) {
      ...
      Object.defineProperty(n, "__esModule", { value: !0 }),
        (n.setupMode = n.setupMode1 = void 0),
        (n.setupMode1 = function (e) {
          var n = new t.WorkerManager(e),
            o = function () {
          ...
          r.languages.registerCompletionItemProvider(
            a,
            new i.CompletionAdapter(o),
          ),
            r.languages.registerHoverProvider(a, new i.HoverAdapter(o)),
            r.languages.registerDocumentHighlightProvider(
              a,
              new i.DocumentHighlightAdapter(o),
            ),
            r.languages.registerLinkProvider(a, new i.DocumentLinkAdapter(o)),
            r.languages.registerFoldingRangeProvider(
              a,
              new i.FoldingRangeAdapter(o),
            ),
            r.languages.registerDocumentSymbolProvider(
              a,
              new i.DocumentSymbolAdapter(o),
            ),
            r.languages.registerSelectionRangeProvider(
              a,
              new i.SelectionRangeAdapter(o),
            ),
            r.languages.registerRenameProvider(a, new i.RenameAdapter(o)),
            "html" === a &&
              (r.languages.registerDocumentFormattingEditProvider(
                a,
        ...
        (n.setupMode = function (e) {
          ...
          return (
            ...
            d.links &&
              u.push(
                r.languages.registerLinkProvider(
                  c,
                  new i.DocumentLinkAdapter(g),
                ),
              ),
            d.documentSymbols &&
              u.push(
            ...
            d.documentFormattingEdits &&
              u.push(
                r.languages.registerDocumentFormattingEditProvider(
                  c,
                  new i.DocumentFormattingEditProvider(g),
                ),
              ),
            d.documentRangeFormattingEdits &&
              u.push(
                r.languages.registerDocumentRangeFormattingEditProvider(
                  c,
                  new i.DocumentRangeFormattingEditProvider(g),
                ),
              ),
            n.push(o(u)),
            o(n)
