    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              L.objectLiteral(t) &&
              L.uinteger(t.line) &&
              L.uinteger(t.character)
            );
          });
      })((i = t.Position || (t.Position = {}))),
      (function (e) {
        (e.create = function (e, t, n, r) {
          if (L.uinteger(e) && L.uinteger(t) && L.uinteger(n) && L.uinteger(r))
        ...
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              L.defined(t) &&
              r.is(t.range) &&
              (L.string(t.uri) || L.undefined(t.uri))
            );
          });
        ...
        (e.create = function (e, t, n, i) {
          ...
          (e.is = function (e) {
            ...
            return (
              L.defined(t) &&
              r.is(t.targetRange) &&
              L.string(t.targetUri) &&
              (r.is(t.targetSelectionRange) ||
                L.undefined(t.targetSelectionRange)) &&
              (r.is(t.originSelectionRange) ||
                L.undefined(t.originSelectionRange))
            );
          });
      ...
      (function (e) {
        (e.create = function (e, t, n, i) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              L.numberRange(t.red, 0, 1) &&
              L.numberRange(t.green, 0, 1) &&
              L.numberRange(t.blue, 0, 1) &&
              L.numberRange(t.alpha, 0, 1)
            );
          });
      })((o = t.Color || (t.Color = {}))),
      (function (e) {
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              L.string(t.label) &&
              (L.undefined(t.textEdit) || d.is(t)) &&
              (L.undefined(t.additionalTextEdits) ||
                L.typedArray(t.additionalTextEdits, d.is))
            );
          });
      ...
      (function (e) {
        (e.create = function (e, t, n, i, r) {
          ...
          return (
            L.defined(n) && (a.startCharacter = n),
            L.defined(i) && (a.endCharacter = i),
            L.defined(r) && (a.kind = r),
            a
          );
        }),
          (e.is = function (e) {
            var t = e;
            return (
              L.uinteger(t.startLine) &&
              L.uinteger(t.startLine) &&
              (L.undefined(t.startCharacter) || L.uinteger(t.startCharacter)) &&
              (L.undefined(t.endCharacter) || L.uinteger(t.endCharacter)) &&
              (L.undefined(t.kind) || L.string(t.kind))
            );
          });
      ...
      (function (e) {
        (e.create = function (e, t, n, i, r, a) {
          ...
          return (
            L.defined(n) && (o.severity = n),
            L.defined(i) && (o.code = i),
            L.defined(r) && (o.source = r),
            L.defined(a) && (o.relatedInformation = a),
            o
          );
        }),
          (e.is = function (e) {
            ...
            return (
              ...
              r.is(n.range) &&
              L.string(n.message) &&
              (L.number(n.severity) || L.undefined(n.severity)) &&
              (L.integer(n.code) || L.string(n.code) || L.undefined(n.code)) &&
              ...
              (L.undefined(n.relatedInformation) ||
                L.typedArray(n.relatedInformation, s.is))
            );
          });
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              L.objectLiteral(t) &&
              L.string(t.label) &&
              (L.boolean(t.needsConfirmation) ||
                void 0 === t.needsConfirmation) &&
              (L.string(t.description) || void 0 === t.description)
            );
          });
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              L.defined(t) && _.is(t.textDocument) && Array.isArray(t.edits)
            );
          });
            ...
            return (
              ...
              (void 0 === t.options ||
                ((void 0 === t.options.overwrite ||
                  L.boolean(t.options.overwrite)) &&
                  (void 0 === t.options.ignoreIfExists ||
                    L.boolean(t.options.ignoreIfExists)))) &&
            ...
            return (
              ...
              (void 0 === t.options ||
                ((void 0 === t.options.recursive ||
                  L.boolean(t.options.recursive)) &&
                  (void 0 === t.options.ignoreIfNotExists ||
                    L.boolean(t.options.ignoreIfNotExists)))) &&
              (void 0 === t.annotationId || u.is(t.annotationId))
            );
          });
          ...
          (this._textEditChanges = Object.create(null)),
            void 0 !== e
              ? ((this._workspaceEdit = e),
                e.documentChanges
                  ? ((this._changeAnnotations = new S(e.changeAnnotations)),
    ...
    (t.WorkspaceChange = x),
        ...
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              L.defined(t) &&
              L.string(t.uri) &&
              (null === t.version || L.integer(t.version))
            );
          });
      })(
        (_ =
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              t && L.string(t.newText) && r.is(t.insert) && r.is(t.replace)
            );
          });
      ...
      (function (e) {
        (e.fromPlainText = function (e) {
          ...
          (e.is = function (e) {
            ...
            return (
              L.string(t) ||
              (L.objectLiteral(t) && L.string(t.language) && L.string(t.value))
            );
          });
      ...
      (function (e) {
        e.create = function (e, t) {
          ...
          var r = { label: e };
          return (
            L.defined(t) && (r.documentation = t),
            L.defined(n) ? (r.parameters = n) : (r.parameters = []),
            r
          );
        };
        ...
        (e.create = function (e, t, n, i, r, a) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (void 0 === t.detail || L.string(t.detail)) &&
              (void 0 === t.deprecated || L.boolean(t.deprecated)) &&
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              L.defined(t) &&
              L.typedArray(t.diagnostics, l.is) &&
              (void 0 === t.only || L.typedArray(t.only, L.string))
            );
          });
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              t &&
              L.string(t.title) &&
              (void 0 === t.diagnostics || L.typedArray(t.diagnostics, l.is)) &&
              (void 0 === t.kind || L.string(t.kind)) &&
              (void 0 !== t.edit || void 0 !== t.command) &&
              (void 0 === t.command || c.is(t.command)) &&
              (void 0 === t.isPreferred || L.boolean(t.isPreferred)) &&
        ...
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              L.defined(t) &&
              r.is(t.range) &&
              (L.undefined(t.command) || c.is(t.command))
            );
          });
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              L.defined(t) && L.uinteger(t.tabSize) && L.boolean(t.insertSpaces)
            );
          });
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              L.defined(t) &&
              r.is(t.range) &&
              (L.undefined(t.target) || L.string(t.target))
            );
          });
        ...
        (e.create = function (e, t, n, i) {
          ...
          (e.is = function (e) {
            ...
            return !!(
              L.defined(t) &&
              L.string(t.uri) &&
              (L.undefined(t.languageId) || L.string(t.languageId)) &&
              L.uinteger(t.lineCount) &&
              L.func(t.getText) &&
              L.func(t.positionAt) &&
              L.func(t.offsetAt)
            );
...
!(function (e) {
        ...
        for (var i = 0, o = t; i < o.length; i++) {
          ...
          if (e.isIncremental(s)) {
            ...
            if (u - h === m.length)
              ...
              m.length < 1e4
                ? p.splice.apply(p, __spreadArray([h + 1, u - h], m, !1))
                : (this._lineOffsets = p =
                    p.slice(0, h + 1).concat(m, p.slice(u + 1)));
            var b = s.text.length - (d - c);
            if (0 !== b)
              for (f = h + 1 + m.length, g = p.length; f < g; f++)
                p[f] = p[f] + b;
          } else {
    ...
    (e.create = function (e, t, i, r) {
      ...
      (e.applyEdits = function (e, t) {
        for (
          ...
          d > r && a.push(n.substring(r, d)),
            c.newText.length && a.push(c.newText),
            (r = e.offsetAt(c.range.end));
        }
  ...
  (function (e) {
    ...
    var n = e("vscode-nls"),
      ...
      b = " ".charCodeAt(0),
      v = "\t".charCodeAt(0),
      _ = { "text/x-handlebars-template": !0, "text/html": !0 };
    t.createScanner = function (e, t, n, m) {
      void 0 === t && (t = 0),
        void 0 === n && (n = i.ScannerState.WithinContent),
        void 0 === m && (m = !1);
      var f,
        g,
        b,
      ...
      function M() {
        ...
        switch (T) {
          case i.ScannerState.WithinComment:
            return y.advanceIfChars([s, s, c])
              ? ((T = i.ScannerState.WithinContent),
                L(t, i.TokenType.EndCommentTag))
              : (y.advanceUntilChars([s, s, c]), L(t, i.TokenType.Comment));
          case i.ScannerState.WithinDoctype:
            return y.advanceIfChar(c)
              ? ((T = i.ScannerState.WithinContent),
                L(t, i.TokenType.EndDoctypeTag))
              : (y.advanceUntilChar(c), L(t, i.TokenType.Doctype));
          case i.ScannerState.WithinContent:
            if (y.advanceIfChar(l)) {
              if (!y.eos() && y.peekChar() === o) {
                if (y.advanceIfChars([o, s, s]))
                  return (
                    (T = i.ScannerState.WithinComment),
                    L(t, i.TokenType.StartCommentTag)
                  );
                if (y.advanceIfRegExp(/^!doctype/i))
                  return (
                    (T = i.ScannerState.WithinDoctype),
                    L(t, i.TokenType.StartDoctypeTag)
                  );
              }
              return y.advanceIfChar(d)
                ? ((T = i.ScannerState.AfterOpeningEndTag),
                  L(t, i.TokenType.EndTagOpen))
                : ((T = i.ScannerState.AfterOpeningStartTag),
                  L(t, i.TokenType.StartTagOpen));
            }
            return y.advanceUntilChar(l), L(t, i.TokenType.Content);
          case i.ScannerState.AfterOpeningEndTag:
            return x().length > 0
              ? ((T = i.ScannerState.WithinEndTag), L(t, i.TokenType.EndTag))
              : y.skipWhitespace()
                ? L(
                    t,
                ...
                : ((T = i.ScannerState.WithinEndTag),
                  y.advanceUntilChar(c),
                  t < y.pos()
                    ? L(
                        t,
                        i.TokenType.Unknown,
                        r("error.endTagNameExpected", "End tag name expected."),
                      )
                    : M());
          case i.ScannerState.WithinEndTag:
            if (y.skipWhitespace()) return L(t, i.TokenType.Whitespace);
            if (y.advanceIfChar(c))
              return (
                (T = i.ScannerState.WithinContent),
                L(t, i.TokenType.EndTagClose)
              );
            if (m && y.peekChar() === l)
              return (
                (T = i.ScannerState.WithinContent),
                L(
                  ...
                  r("error.closingBracketMissing", "Closing bracket missing."),
                )
              );
          ...
          case i.ScannerState.AfterOpeningStartTag:
            return (
              ...
              b.length > 0
                ? ((g = !1),
                  (T = i.ScannerState.WithinTag),
                  L(t, i.TokenType.StartTag))
                : y.skipWhitespace()
                  ? L(
                      t,
                      i.TokenType.Whitespace,
          ...
          case i.ScannerState.WithinTag:
            return y.skipWhitespace()
              ...
              : g &&
                ...
                : y.advanceIfChars([d, c])
                  ? ((T = i.ScannerState.WithinContent),
                    L(t, i.TokenType.StartTagSelfClose))
                  : y.advanceIfChar(c)
                    ? ((T =
                        "script" === b
                          ? w && _[w]
                            ? i.ScannerState.WithinContent
                            : i.ScannerState.WithinScriptContent
                          : "style" === b
          ...
          case i.ScannerState.AfterAttributeName:
            return y.skipWhitespace()
              ? ((g = !0), L(t, i.TokenType.Whitespace))
              : y.advanceIfChar(h)
                ? ((T = i.ScannerState.BeforeAttributeValue),
                  L(t, i.TokenType.DelimiterAssign))
                : ((T = i.ScannerState.WithinTag), M());
          case i.ScannerState.BeforeAttributeValue:
            ...
            if (n.length > 0)
              return (
                y.peekChar() === c &&
                  y.peekChar(-1) === d &&
                  (y.goBack(1), (n = n.substr(0, n.length - 1))),
                "type" === v && (w = n),
                (T = i.ScannerState.WithinTag),
                (g = !1),
                L(t, i.TokenType.AttributeValue)
              );
            var a = y.peekChar();
            return a === p || a === u
              ? (y.advance(1),
                y.advanceUntilChar(a) && y.advance(1),
                "type" === v &&
                  (w = y.getSource().substring(t + 1, y.pos() - 1)),
                (T = i.ScannerState.WithinTag),
                (g = !1),
                L(t, i.TokenType.AttributeValue))
          ...
          case i.ScannerState.WithinScriptContent:
            ...
            return (
              (T = i.ScannerState.WithinContent),
              t < y.pos() ? L(t, i.TokenType.Script) : M()
            );
          case i.ScannerState.WithinStyleContent:
            return (
              y.advanceUntilRegExp(/<\/style/i),
              (T = i.ScannerState.WithinContent),
              t < y.pos() ? L(t, i.TokenType.Styles) : M()
            );
        }
        return (
          y.advance(1),
          (T = i.ScannerState.WithinContent),
          L(t, i.TokenType.Unknown, e)
        );
      }
      return {
        scan: function () {
          var e = y.pos(),
            t = T,
            n = M();
          return n === i.TokenType.EOS ||
            e !== y.pos() ||
            (m &&
              (n === i.TokenType.StartTagClose ||
                n === i.TokenType.EndTagClose))
            ? n
            : (console.log(
  ...
  (function (e) {
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.binarySearch = t.findFirst = void 0),
  ...
  (function (e) {
      ...
      o = (function () {
        ...
        return (
          ...
          (e.prototype.findNodeBefore = function (e) {
            var t =
              (0, i.findFirst)(this.children, function (t) {
                return e <= t.start;
              }) - 1;
            if (t >= 0) {
    ...
    (t.Node = o),
      (t.parse = function (e) {
        for (
          var t = (0, n.createScanner)(e, void 0, void 0, !0),
            i = new o(0, e.length, [], void 0),
            s = i,
            l = -1,
            c = void 0,
            d = null,
          ...
          switch (h) {
            ...
            case r.TokenType.StartTagClose:
              s.parent &&
                ((s.end = t.getTokenEnd()),
                t.getTokenLength()
                  ? ((s.startTagEnd = t.getTokenEnd()),
                    s.tag &&
                      (0, a.isVoidElement)(s.tag) &&
  ...
  (function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define(
          "vscode-html-languageservice/utils/object",
          ["require", "exports"],
          e,
        );
  })(function (e, t) {
  ...
  (function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define(
          "vscode-html-languageservice/utils/markup",
          ["require", "exports"],
          e,
        );
  })(function (e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.normalizeMarkupContent = void 0),
      (t.normalizeMarkupContent = function (e) {
        if (e)
          return "string" == typeof e
  ...
  (function (e) {
    ...
    (t.HTMLDataProvider = i),
      (t.generateDocumentation = function (e, t, i) {
        void 0 === t && (t = {});
        var r = { kind: i ? "markdown" : "plaintext", value: "" };
        if (e.description && !1 !== t.documentation) {
          var a = (0, n.normalizeMarkupContent)(e.description);
          a && (r.value += a.value);
        }
        if (
          (e.references &&
...
!(function (e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    ...
    "function" == typeof define &&
      define.amd &&
      define(
        "vscode-html-languageservice/services/pathCompletion",
          ...
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (f) {
              switch (f.label) {
                ...
                case 1:
                  return a < o.length
                    ? ((l = o[a]),
                      (function (e) {
                        if (
                          (0, i.startsWith)(e, "http") ||
                          (0, i.startsWith)(e, "https") ||
                          (0, i.startsWith)(e, "//")
                        )
                          return !1;
                        return !0;
                    ...
                    (d = (function (e, t, i) {
                      ...
                      if (-1 === a)
                        ...
                        var o = t.slice(a + 1),
                          ...
                          c = o.indexOf(" "),
                          d = void 0;
                        (d = -1 !== c ? s(l, c) : s(i.end, -1)),
                          (r = n.Range.create(l, d));
                      }
                      return r;
                    })(l.value, c, l.range)),
                ...
                case 3:
                  for (h = f.sent(), u = 0, p = h; u < p.length; u++)
          ...
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (g) {
              switch (g.label) {
                case 0:
                  if (
                    ((s = e.substring(0, e.lastIndexOf("/") + 1)),
                    !(l = r.resolveReference(s || ".", i.uri)))
                  )
                    return [3, 4];
                  g.label = 1;
                case 1:
                  return (
                    g.trys.push([1, 3, , 4]),
                    (c = []),
                    [4, this.readDirectory(l)]
                  );
                case 2:
                  for (d = g.sent(), h = 0, u = d; h < u.length; h++)
                    (p = u[h]),
                      (m = p[0]),
                      (f = p[1]),
                      m.charCodeAt(0) !== a &&
                        c.push(o(m, f === n.FileType.Directory, t));
                  return [2, c];
                case 3:
                  return g.sent(), [3, 4];
                case 4:
...
!(function (e) {
      ...
      return (
            ...
            return __generator(this, function (c) {
              switch (c.label) {
                case 0:
                  ...
                  (a = new d.PathCompletionParticipant(
                    this.lsOptions.fileSystemProvider.readDirectory,
                  )),
        ...
        (e.prototype._doComplete = function (e, t, a, l) {
              ...
              f.forEach(function (e) {
                e.provideTags().forEach(function (e) {
                  d.items.push({
                    ...
                    documentation: (0, c.generateDocumentation)(e, void 0, g),
            ...
            for (t && (o = o.parent); o; ) {
              ...
              if (s && (!o.closed || (o.endTagStart && o.endTagStart > v))) {
                ...
                if (null !== h && null !== u && h !== u) {
                  var p = h + "</" + s + a;
                  (l.textEdit = i.TextEdit.replace(k(e - 1 - u.length), p)),
                    (l.filterText = u + "</" + s);
                }
          ...
          function A(e, t) {
            var n;
            void 0 === t && (t = v);
            for (var r = v; r < t && "<" !== b[r]; ) r++;
            var s = b.substring(e, t),
              h = k(e, r),
              u = "";
            if (
              !m(
              ...
              var p =
                null !== (n = null == l ? void 0 : l.attributeDefaultValue) &&
                void 0 !== n
                  ? n
                  : "doublequotes";
              u =
            ...
            var w,
              y =
                ...
                _.attributeNames.forEach(function (e) {
                  w[e] = !0;
                }),
                w);
            return (
                  ...
                  if (!y[e.name]) {
                    ...
                    "v" !== e.valueSet &&
                      ...
                      d.items.push({
                        ...
                        kind:
                          "handler" === e.valueSet
                            ? i.CompletionItemKind.Function
                            : i.CompletionItemKind.Value,
                        documentation: (0, c.generateDocumentation)(
                          e,
                          void 0,
                          g,
                        ),
                        textEdit: i.TextEdit.replace(h, n),
                        insertTextFormat: i.InsertTextFormat.Snippet,
                        command: t,
                      });
                  }
          ...
          function H() {
            for (
              var e = v - 1, n = t.character;
              e >= 0 && (0, o.isLetterOrDigit)(b, e);
              ...
              for (var s in r.entities)
                if ((0, o.endsWith)(s, ";")) {
                  ...
                  d.items.push({
                    ...
                    documentation: h(
                      "entity.propose",
                      "Character entity representing '" + r.entities[s] + "'",
                    ),
          ...
          for (
            var z, U = y.scan();
            U !== i.TokenType.EOS && y.getTokenOffset() <= v;
            ...
            switch (U) {
              ...
              case i.TokenType.StartTag:
                if (y.getTokenOffset() <= v && v <= y.getTokenEnd())
                  return S(y.getTokenOffset(), y.getTokenEnd());
                T = y.getTokenText();
                break;
              case i.TokenType.AttributeName:
                if (y.getTokenOffset() <= v && v <= y.getTokenEnd())
                  return A(y.getTokenOffset(), y.getTokenEnd());
                w = y.getTokenText();
                break;
              ...
              case i.TokenType.AttributeValue:
                if (y.getTokenOffset() <= v && v <= y.getTokenEnd())
                  return C(y.getTokenOffset(), y.getTokenEnd());
                break;
              ...
              case i.TokenType.EndTagOpen:
                if (v <= y.getTokenEnd())
                  return L(y.getTokenOffset() + 1, !1, R(i.TokenType.EndTag));
                break;
        ...
        (e.prototype.doTagComplete = function (e, t, r) {
          ...
          if (">" === o) {
            if (
              (c = r.findNodeBefore(a)) &&
              c.tag &&
              !(0, s.isVoidElement)(c.tag) &&
              c.start < a &&
              (!c.endTagStart || c.endTagStart > a)
            )
              for (
                var l = (d = (0, n.createScanner)(e.getText(), c.start)).scan();
                l !== i.TokenType.EOS && d.getTokenEnd() <= a;

              ) {
                if (l === i.TokenType.StartTagClose && d.getTokenEnd() === a)
                  return "$0</" + c.tag + ">";
                l = d.scan();
              }
          } else if ("/" === o) {
            for (
              var c = r.findNodeBefore(a);
              c && c.closed && !(c.endTagStart && c.endTagStart > a);
            ...
            if (c && c.tag) {
              var d;
              for (
                l = (d = (0, n.createScanner)(e.getText(), c.start)).scan();
                l !== i.TokenType.EOS && d.getTokenEnd() <= a;

              ) {
                if (l === i.TokenType.EndTagOpen && d.getTokenEnd() === a)
                  return c.tag + ">";
                l = d.scan();
              }
            }
        ...
        (e.prototype.doesSupportMarkdown = function () {
          var e, t, n;
          if (!(0, l.isDefined)(this.supportsMarkdown)) {
            if (!(0, l.isDefined)(this.lsOptions.clientCapabilities))
              ...
              null ===
                (n =
                  null ===
                    (t =
                      null ===
                        (e = this.lsOptions.clientCapabilities.textDocument) ||
                      void 0 === e
                        ? void 0
            ...
            this.supportsMarkdown =
              Array.isArray(r) && -1 !== r.indexOf(i.MarkupKind.Markdown);
          }
  ...
  function m(e, t, r, a) {
    for (
      var o = (0, n.createScanner)(e, t, r), s = o.scan();
      s === i.TokenType.Whitespace;
  ...
  (function (e) {
    ...
    var n = e("../parser/htmlScanner"),
      ...
      c = (function () {
        ...
        return (
          (e.prototype.doHover = function (e, t, r, c) {
                    ...
                    if (
                      (n.provideTags().forEach(function (n) {
                        if (n.name.toLowerCase() === e.toLowerCase()) {
                          var r = (0, a.generateDocumentation)(n, c, h);
                          r ||
                            (r = {
                      ...
                      return (i.contents = d(i.contents)), { value: i };
                  },
                  r = 0,
                  o = f;
                r < o.length;
            ...
            function b(t, r) {
              for (
                var a = (0, n.createScanner)(e.getText(), r), o = a.scan();
                o !== i.TokenType.EOS &&
                (a.getTokenEnd() < u || (a.getTokenEnd() === u && o !== t));
              ...
              return (function (e, t, n) {
                for (
                  var i = function (i) {
                      var r = null;
                      if (
                        (i.provideAttributes(e).forEach(function (e) {
                          if (t === e.name && e.description) {
                            var i = (0, a.generateDocumentation)(e, c, h);
                            r = i ? { contents: i, range: n } : null;
                          }
                        }),
                        r)
                      )
                        return (r.contents = d(r.contents)), { value: r };
                    },
                    r = 0,
                    o = f;
                  r < o.length;
            ...
            var y = (function () {
              for (
                var e = u - 1, n = t.character;
                e >= 0 && (0, s.isLetterOrDigit)(m, e);

              )
                e--, n--;
              for (var r = e + 1, a = n; (0, s.isLetterOrDigit)(m, r); )
                r++, a++;
              if (e >= 0 && "&" === m[e]) {
                return ";" === m[r]
                  ? i.Range.create(
                      i.Position.create(t.line, n),
                      i.Position.create(t.line, a + 1),
                    )
                  : i.Range.create(
                      i.Position.create(t.line, n),
                      i.Position.create(t.line, a),
                    );
              }
              return null;
            })();
            if (y)
              return (function (e, t) {
                var n = (function (e) {
                  for (
                    var t = u - 1, n = "&";
                    t >= 0 && (0, s.isLetterOrDigit)(e, t);

                  )
                    t--;
                  for (t += 1; (0, s.isLetterOrDigit)(e, t); )
                    (n += e[t]), (t += 1);
                  return n + ";";
                })(e);
            ...
            if (T) {
              var k = p.tag,
                ...
                x = (function (t, r) {
                  for (
                    var a = (0, n.createScanner)(e.getText(), t),
                      o = a.scan(),
                      s = void 0;
                    o !== i.TokenType.EOS && a.getTokenEnd() <= r;

                  )
                    (o = a.scan()) === i.TokenType.AttributeName &&
                      (s = a.getTokenText());
                  return s;
                ...
                return (function (e, t, n, i) {
                  for (
                    var r = function (r) {
                        var o = null;
                        if (
                          (r.provideValues(e, t).forEach(function (e) {
                            if (n === e.name && e.description) {
                              var t = (0, a.generateDocumentation)(e, c, h);
                              o = t ? { contents: t, range: i } : null;
                            }
                          }),
                          o)
                        )
                          return (o.contents = d(o.contents)), { value: o };
                      },
                      o = 0,
                      s = f;
                    o < s.length;
          ...
          (e.prototype.doesSupportMarkdown = function () {
            var e, t, n;
            if (!(0, r.isDefined)(this.supportsMarkdown)) {
              if (!(0, r.isDefined)(this.lsOptions.clientCapabilities))
                return (this.supportsMarkdown = !0), this.supportsMarkdown;
              var a =
                null ===
                  (n =
                  ...
                  : n.contentFormat;
              this.supportsMarkdown =
                Array.isArray(a) && -1 !== a.indexOf(i.MarkupKind.Markdown);
            }
            return this.supportsMarkdown;
          }),
          e
  ...
  (function () {
          ...
          function (e, t, n) {
            ...
            (p.prototype.get_parser_token = function () {
              ...
              (m.prototype.beautify = function () {
                ...
                for (var u = null, m = h.next(); m.type !== o.EOF; )
                  m.type === o.TAG_OPEN || m.type === o.COMMENT
                    ? (r = u = this._handle_tag_open(d, m, r, i))
                    : m.type === o.ATTRIBUTE ||
                        m.type === o.EQUALS ||
                        m.type === o.VALUE ||
                        (m.type === o.TEXT && !r.tag_complete)
                      ? (u = this._handle_inside_tag(d, m, r, h))
                      : m.type === o.TAG_CLOSE
                        ? (u = this._handle_tag_close(d, m, r))
                        : m.type === o.TEXT
                          ? (u = this._handle_text(d, m, r))
                          : d.add_raw_token(m),
                    (i = u),
                    (m = h.next());
                ...
                if (
                  ...
                  (a =
                    ...
                    (!n.is_inline_element &&
                      ...
                      "TK_CONTENT" !== r.type)),
                    (n.is_content_unformatted || n.is_unformatted) && (a = !1),
                    a && e.print_newline(!1);
                } else
              ...
              if (!e.is_empty_element && e.is_start_tag && e.parent) {
                if ("body" === e.tag_name)
                  ...
                  "rp" === e.tag_name || "rt" === e.tag_name
                    ...
                    : "optgroup" === e.tag_name
                      ? (t =
                          t || this._tag_stack.try_pop("optgroup", ["select"]))
                      : "option" === e.tag_name
                        ? (t =
                            t ||
              ...
              (d.prototype._read_processing = function (e) {
                ...
                if ("<" === e) {
                  ...
                  ("!" !== i && "?" !== i) ||
                    ...
                    n &&
                      ((t = this._create_token(l.COMMENT, n)).directives =
                        null);
                }
                return t;
              }),
    ...
    if ("function" == typeof define && define.amd)
      ...
      "undefined" != typeof window
        ? (window.html_beautify = function (e, n) {
            return t(e, n, window.js_beautify, window.css_beautify);
          })
        : "undefined" != typeof global &&
          (global.html_beautify = function (e, n) {
  ...
  (function (e) {
    ...
    t.format = function (e, t, d) {
      ...
      if (t) {
        ...
        (v === h.length || l(h, v)) && (b = v),
          (t = n.Range.create(e.positionAt(f), e.positionAt(b)));
        var _ = h.substring(0, f);
        if (new RegExp(/.*[<][^>]*$/).test(_))
          return [{ range: t, newText: (h = h.substring(f, b)) }];
        ...
        t = n.Range.create(n.Position.create(0, 0), e.positionAt(h.length));
      var y = {
          indent_size: m,
          ...
          templating: s(d, "all"),
          unformatted_content_delimiter: a(
            d,
            "unformattedContentDelimiter",
            "",
          ),
        },
        T = (0, i.html_beautify)(h.replace(/^\s+/, ""), y);
      if (p > 0) {
        var k = d.insertSpaces
          ? (0, r.repeat)(" ", m * p)
          : (0, r.repeat)("\t", p);
        (T = T.split("\n").join("\n" + k)),
          0 === t.start.character && (T = k + T);
      }
      ...
      var e = {
          470: (e) => {
            ...
            var i = {
              resolve: function () {
                for (
                  var e, i = "", r = !1, a = arguments.length - 1;
                  a >= -1 && !r;
                  a--
                ) {
                  var o;
                  a >= 0
                    ...
                    t(o),
                    0 !== o.length &&
                      ((i = o + "/" + i), (r = 47 === o.charCodeAt(0)));
                }
                return (
                  (i = n(i, !r)),
                  r ? (i.length > 0 ? "/" + i : "/") : i.length > 0 ? i : "."
                );
              },
              ...
              relative: function (e, n) {
                ...
                for (
                  var a = e.length, o = a - r, s = 1;
                  s < n.length && 47 === n.charCodeAt(s);
                  ++s
                );
                for (
                  var l = n.length - s, c = o < l ? o : l, d = -1, h = 0;
                  h <= c;
                  ++h
                ) {
                  if (h === c) {
              ...
              extname: function (e) {
                t(e);
                for (
                  var n = -1, i = 0, r = -1, a = !0, o = 0, s = e.length - 1;
                  s >= 0;
                  --s
                ) {
              ...
              parse: function (e) {
                ...
                a ? ((n.root = "/"), (i = 1)) : (i = 0);
                for (
                  var o = -1, s = 0, l = -1, c = !0, d = e.length - 1, h = 0;
                  d >= i;
                  --d
                )
                  ...
                  (e.prototype.with = function (e) {
                    ...
                    return (
                      ...
                      void 0 === n
                        ? (n = this.authority)
                        : null === n && (n = d),
                      void 0 === i ? (i = this.path) : null === i && (i = d),
                      void 0 === r ? (r = this.query) : null === r && (r = d),
                      void 0 === a
                        ? (a = this.fragment)
                        : null === a && (a = d),
                      t === this.scheme &&
          ...
          679: function (e, t, n) {
            ...
            ((r = t.Utils || (t.Utils = {})).joinPath = function (e) {
              for (var t = [], n = 1; n < arguments.length; n++)
                t[n - 1] = arguments[n];
              return e.with({ path: o.join.apply(o, i([e.path], t)) });
            }),
              (r.resolvePath = function (e) {
                for (var t = [], n = 1; n < arguments.length; n++)
                  t[n - 1] = arguments[n];
                var r = e.path || "/";
                return e.with({ path: o.resolve.apply(o, i([r], t)) });
              }),
  ...
  (function (e) {
    ...
    t.findDocumentLinks = function (e, t) {
      for (
        var r = [],
          l = (0, n.createScanner)(e.getText(), 0),
          c = l.scan(),
          d = void 0,
          h = !1,
          u = void 0,
        ...
        switch (c) {
          ...
          case a.TokenType.AttributeValue:
            if ("src" === d || "href" === d) {
              ...
              if (!h)
                (b = s(e, t, m, l.getTokenOffset(), l.getTokenEnd(), u)) &&
                  r.push(b);
              h &&
                void 0 === u &&
                (u = o(m)) &&
  ...
  (function (e) {
    ...
    function o(e, t, r) {
      for (
        var a = (0, n.createScanner)(t.getText(), r), o = a.scan();
        o !== i.TokenType.EOS && o !== e;
    ...
    t.findDocumentHighlights = function (e, t, n) {
      ...
      var l = [],
        ...
        d =
          "number" == typeof s.endTagStart &&
          o(i.TokenType.EndTag, e, s.endTagStart);
      return (
        ((c && a(c, t)) || (d && a(d, t))) &&
          (c && l.push({ kind: i.DocumentHighlightKind.Read, range: c }),
          d && l.push({ kind: i.DocumentHighlightKind.Read, range: d })),
        l
      );
    };
  }),
  (function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        ...
        define(
          ...
          ["require", "exports", "../htmlLanguageTypes"],
          e,
        );
  })(function (e, t) {
    "use strict";
    ...
    function i(e, t, r, a) {
      var o = (function (e) {
        ...
        s = n.Location.create(
          e.uri,
          n.Range.create(e.positionAt(t.start), e.positionAt(t.end)),
        ),
        l = {
          name: o,
          location: s,
  ...
  (function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define(
          "vscode-html-languageservice/services/htmlRename",
          ["require", "exports"],
          e,
        );
  })(function (e, t) {
  ...
  (function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define(
          "vscode-html-languageservice/services/htmlMatchingTagPosition",
          ["require", "exports"],
          e,
        );
  })(function (e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.findMatchingTagPosition = void 0),
      (t.findMatchingTagPosition = function (e, t, n) {
        var i = e.offsetAt(t),
          r = n.findNodeAt(i);
  ...
  (function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define(
          "vscode-html-languageservice/services/htmlLinkedEditing",
          ["require", "exports", "../htmlLanguageTypes"],
          e,
        );
  })(function (e, t) {
    ...
    t.findLinkedEditingRanges = function (e, t, i) {
      ...
      return a.endTagStart &&
        ((a.start + "<".length <= r && r <= a.start + "<".length + o) ||
          (a.endTagStart + "</".length <= r &&
            r <= a.endTagStart + "</".length + o))
        ? [
            n.Range.create(
              e.positionAt(a.start + "<".length),
              e.positionAt(a.start + "<".length + o),
            ),
            n.Range.create(
              e.positionAt(a.endTagStart + "</".length),
              e.positionAt(a.endTagStart + "</".length + o),
            ),
          ]
        : null;
    };
  ...
  (function (e) {
    ...
    t.getFoldingRanges = function (e, t) {
      var a = (0, i.createScanner)(e.getText()),
        o = a.scan(),
        s = [],
        l = [],
        c = null,
      ...
      for (; o !== n.TokenType.EOS; ) {
        switch (o) {
          case n.TokenType.StartTag:
            ...
            l.push({ startLine: p, tagName: u }), (c = u);
            break;
          case n.TokenType.EndTag:
            c = a.getTokenText();
            break;
          case n.TokenType.StartTagClose:
            if (!c || !(0, r.isVoidElement)(c)) break;
          ...
          case n.TokenType.StartTagSelfClose:
            ...
            if (m >= 0) {
              var f = l[m];
              (l.length = m),
                (b = e.positionAt(a.getTokenOffset()).line - 1) >
                  (p = f.startLine) &&
                  d !== p &&
                  h({ startLine: p, endLine: b });
            }
            break;
          case n.TokenType.Comment:
            ...
            if (g)
              if (g[1]) l.push({ startLine: p, tagName: "" });
              else {
              ...
              p <
                (b = e.positionAt(
                  a.getTokenOffset() + a.getTokenLength(),
                ).line) &&
                h({
                  startLine: p,
                  endLine: b,
  ...
  (function (e) {
    ...
    function a(e, t, i) {
      for (
        var a = r.Range.create(e.positionAt(t.start), e.positionAt(t.end)),
          o = e.getText(a),
          s = i - t.start,
          l = (0, n.createScanner)(o),
          c = l.scan(),
          d = t.start,
          h = [],
          u = !1,
        ...
        for (
          var n = (function (e, t) {
              var n = (0, i.parse)(e.getText()),
                ...
                l = (function (e) {
                  var t = e,
                    ...
                    i = [];
                  for (; t.parent; )
                    n((t = t.parent)).forEach(function (e) {
                      return i.push(e);
                    });
                  return i;
                })(s);
              if (s.startTagEnd && !s.endTagStart) {
                ...
                var c = r.Range.create(
                  e.positionAt(s.startTagEnd - 2),
                  e.positionAt(s.startTagEnd),
                );
                return (
                  "/>" === e.getText(c)
                    ? l.unshift([s.start + 1, s.startTagEnd - 2])
                    : l.unshift([s.start + 1, s.startTagEnd - 1]),
                  (l = a(e, s, o).concat(l))
                );
              }
              if (!s.startTagEnd || !s.endTagStart) return l;
              return (
                l.unshift([s.start, s.end]),
                s.start < o && o < s.startTagEnd
                  ? (l.unshift([s.start + 1, s.startTagEnd - 1]),
                    (l = a(e, s, o).concat(l)))
                  : s.startTagEnd <= o && o <= s.endTagStart
                    ? (l.unshift([s.startTagEnd, s.endTagStart]), l)
                    : (o >= s.endTagStart + 2 &&
                        l.unshift([s.endTagStart + 2, s.end - 1]),
                      l)
              );
            })(e, t),
            o = void 0,
          ...
          var c = n[l];
          (o && c[0] === o[0] && c[1] === o[1]) ||
            (s = r.SelectionRange.create(
              r.Range.create(e.positionAt(n[l][0]), e.positionAt(n[l][1])),
              s,
            )),
            (o = c);
        }
  ...
  (function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define(
          "vscode-html-languageservice/languageFacts/data/webCustomData",
          ["require", "exports"],
          e,
        );
  })(function (e, t) {
  ...
  (function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define(
          "vscode-html-languageservice/languageFacts/dataManager",
            ...
            (this.dataProviders = []),
              e &&
                this.dataProviders.push(
                  new n.HTMLDataProvider("html5", i.htmlData),
                ),
              (r = this.dataProviders).push.apply(r, t);
          }),
...
!(function (e) {
  ...
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.getDefaultHTMLDataProvider =
      t.newHTMLDataProvider =
  ...
  (t.getLanguageService = function (e) {
    ...
    (t.newHTMLDataProvider = _),
    (t.getDefaultHTMLDataProvider = function () {
...
define("vs/language/html/htmlWorker", [
  ...
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.create = t.HTMLWorker = void 0);
  var i = (function () {
    function e(e, t) {
      (this._ctx = e),
        (this._languageSettings = t.languageSettings),
        (this._languageId = t.languageId);
      var i = this._languageSettings.data,
        r = null == i ? void 0 : i.useDefaultDataProvider,
        a = [];
      if (null == i ? void 0 : i.dataProviders)
        for (var o in i.dataProviders)
          a.push(n.newHTMLDataProvider(o, i.dataProviders[o]));
    ...
    return (
        ...
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (o) {
            return (
              ...
              (r = __assign(__assign({}, this._languageSettings.format), n)),
      ...
      (e.prototype._getTextDocument = function (e) {
        for (var t = 0, i = this._ctx.getMirrorModels(); t < i.length; t++) {
          var r = i[t];
          if (r.uri.toString() === e)
