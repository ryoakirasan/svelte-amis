                ...
                case 1:
                  return (
                    ...
                    this._updateExtraLibsToken !== e
                      ? [2]
                      : (t.updateExtraLibs(this._defaults.getExtraLibs()), [2])
                  );
              }
            });
          });
  ...
  define(
    ...
    function (e, t) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.libFileSet["lib.es2021.d.ts"] = !0),
        (t.libFileSet["lib.es2021.full.d.ts"] = !0),
        (t.libFileSet["lib.es2021.promise.d.ts"] = !0),
        (t.libFileSet["lib.es2021.string.d.ts"] = !0),
        (t.libFileSet["lib.es2021.weakref.d.ts"] = !0),
  ...
  function (e, t, n, r, i) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.InlayHintsAdapter =
        ...
        t.ReferenceAdapter =
        t.DefinitionAdapter =
        t.OccurrencesAdapter =
        t.QuickInfoAdapter =
        t.SignatureHelpAdapter =
        t.SuggestAdapter =
        t.DiagnosticsAdapter =
        t.LibFiles =
        t.Adapter =
        t.flattenDiagnosticMessageText =
          void 0),
      (function (e) {
        (e[(e.None = 0)] = "None"),
          (e[(e.Block = 1)] = "Block"),
      ...
      c = (function () {
        ...
        return (
          ...
          (e.prototype.getOrCreateModel = function (e) {
            ...
            var s = n.typescriptDefaults.getExtraLibs()[e];
    ...
    var d = (function (e) {
      function t(t, n, r, s) {
        ...
        var a = function (e) {
            if (e.getLanguageId() === r) {
              var t,
                ...
                s = e.onDidChangeContent(function () {
                  clearTimeout(t), (t = window.setTimeout(n, 500));
                }),
                a = e.onDidChangeAttached(function () {
                  o._defaults.getDiagnosticsOptions().onlyVisible &&
                    (e.isAttachedToEditor()
                      ? n()
                      : i.editor.setModelMarkers(e, o._selector, []));
                });
              (o._listener[e.uri.toString()] = {
                dispose: function () {
                  s.dispose(), a.dispose(), clearTimeout(t);
                },
              }),
                n();
            }
        ...
        o._disposables.push(
          i.editor.onDidCreateModel(function (e) {
            return a(e);
          }),
        ),
          o._disposables.push(i.editor.onWillDisposeModel(l)),
          o._disposables.push(
        ...
        return (
          o._disposables.push(o._defaults.onDidChange(u)),
          o._disposables.push(o._defaults.onDidExtraLibsChange(u)),
                  ...
                  return (
                    ...
                    e.isDisposed()
                      ...
                      : ((n = []),
                        ...
                        (s = r.noSyntaxValidation),
                        (o = r.noSemanticValidation),
                        (a = r.noSuggestionDiagnostics),
                        s ||
                          n.push(t.getSyntacticDiagnostics(e.uri.toString())),
                        o || n.push(t.getSemanticDiagnostics(e.uri.toString())),
                        a ||
                          n.push(t.getSuggestionDiagnostics(e.uri.toString())),
                        [4, Promise.all(n)])
                  );
                case 2:
                  return !(l = p.sent()) || e.isDisposed()
                    ? [2]
                    : ((u = l
                        .reduce(function (e, t) {
                          return t.concat(e);
                      ...
                      (c = u
                        ...
                        .map(function (e) {
                          return e.file ? i.Uri.parse(e.file.fileName) : null;
                        })),
        ...
        (t.prototype._convertRelatedInformation = function (e, t) {
          ...
          return (
            t.forEach(function (t) {
              var i = e;
              if (
                (t.file && (i = n._libFiles.getOrCreateModel(t.file.fileName)),
                i)
              ) {
                var s = t.start || 0,
                  a = t.length || 1,
    ...
    var p = (function (e) {
      ...
      return (
        ...
        (t.prototype.provideCompletionItems = function (e, n, r, s) {
          return __awaiter(this, void 0, void 0, function () {
            var r, s, o, a, l, u, c;
              ...
              switch (d.label) {
                ...
                case 1:
                  return (
                    ...
                    e.isDisposed()
                      ? [2]
                      : [4, l.getCompletionsAtPosition(o.toString(), a)]
                  );
                case 2:
                  return !(u = d.sent()) || e.isDisposed()
                    ? [2]
                    : ((c = u.entries.map(function (r) {
                        var l,
                          u = s;
                        if (r.replacementSpan) {
                          var c = e.getPositionAt(r.replacementSpan.start),
                            d = e.getPositionAt(
                        ...
                        return (
                          -1 !==
                            (null === (l = r.kindModifiers) || void 0 === l
                              ? void 0
                              : l.indexOf("deprecated")) &&
                            p.push(i.languages.CompletionItemTag.Deprecated),
                          {
                            uri: o,
                            position: n,
                            offset: a,
              ...
              switch (l.label) {
                ...
                case 1:
                  return [
                    ...
                    l
                      .sent()
                      .getCompletionEntryDetails(r.toString(), s, n.label),
                  ];
                case 2:
                  return (o = l.sent())
                    ? [
                        2,
                        {
                          ...
                          position: i,
                          label: o.name,
                          kind: t.convertKind(o.kind),
                          detail: a(o.displayParts),
                          documentation: {
                            value: t.createDocumentationString(o),
                          },
                        },
                      ]
                    : [2, n];
          ...
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (c) {
              switch (c.label) {
                case 0:
                  return (
                    (r = e.uri), (s = e.getOffsetAt(n)), [4, this._worker(r)]
                  );
                case 1:
                  return (
                    (o = c.sent()),
                    e.isDisposed()
                      ...
                      : [
                          4,
                          o.getSignatureHelpItems(r.toString(), s, {
                  ...
                  return !(l = c.sent()) || e.isDisposed()
                    ...
                    : ((u = {
                      ...
                      l.items.forEach(function (e) {
                        ...
                        (t.documentation = { value: a(e.documentation) }),
                          (t.label += a(e.prefixDisplayParts)),
                          e.parameters.forEach(function (n, r, i) {
                            var s = a(n.displayParts),
                              o = {
                                label: s,
                                documentation: { value: a(n.documentation) },
                              };
                            (t.label += s),
                              t.parameters.push(o),
                              r < i.length - 1 &&
                                (t.label += a(e.separatorDisplayParts));
                          }),
          ...
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (c) {
              switch (c.label) {
                case 0:
                  return (
                    (n = e.uri), (r = e.getOffsetAt(t)), [4, this._worker(n)]
                  );
                case 1:
                  return (
                    (i = c.sent()),
                  ...
                  return !(s = c.sent()) || e.isDisposed()
                    ...
                    : ((o = a(s.documentation)),
                      ...
                      [
                        2,
                        {
                          range: this._textSpanToRange(e, s.textSpan),
                          contents: [
                            { value: "```typescript\n" + u + "\n```\n" },
                            { value: o + (l ? "\n\n" + l : "") },
                          ],
              ...
              switch (l.label) {
                ...
                case 1:
                  return (
                    ...
                    e.isDisposed()
                      ? [2]
                      : [4, s.getOccurrencesAtPosition(n.toString(), r)]
                  );
                case 2:
                  return !(o = l.sent()) || e.isDisposed()
                    ? [2]
                    : [
                        2,
                        o.map(function (t) {
              ...
              switch (p.label) {
                ...
                case 1:
                  return (
                    ...
                    e.isDisposed()
                      ? [2]
                      : [4, s.getDefinitionAtPosition(n.toString(), r)]
                  );
                case 2:
                ...
                case 3:
                  ...
                  for (a = [], l = 0, u = o; l < u.length; l++)
                    (c = u[l]),
                      (d = this._libFiles.getOrCreateModel(c.fileName)) &&
                        a.push({
                          uri: d.uri,
                          range: this._textSpanToRange(d, c.textSpan),
                        });
                  return [2, a];
              }
            });
              ...
              switch (p.label) {
                ...
                case 1:
                  return (
                    ...
                    e.isDisposed()
                      ? [2]
                      : [4, s.getReferencesAtPosition(n.toString(), r)]
                  );
                case 2:
                  return !(o = p.sent()) || e.isDisposed()
                    ? [2]
          ...
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (l) {
              switch (l.label) {
                ...
                case 2:
                  return !(r = l.sent()) || e.isDisposed()
                    ? [2]
                    : ((s = function (t, n, r) {
                        var o = {
                          name: n.text,
                          detail: "",
                          kind: S[n.kind] || i.languages.SymbolKind.Variable,
                          range: a._textSpanToRange(e, n.spans[0]),
                          selectionRange: a._textSpanToRange(e, n.spans[0]),
                          tags: [],
                        };
                        if (
                          (r && (o.containerName = r),
                          ...
                          for (var l = 0, u = n.childItems; l < u.length; l++) {
                            var c = u[l];
                            s(t, c, o.name);
                          }
                        t.push(o);
    ...
    (S[y.module] = i.languages.SymbolKind.Module),
      (S[y.class] = i.languages.SymbolKind.Class),
      (S[y.enum] = i.languages.SymbolKind.Enum),
      (S[y.interface] = i.languages.SymbolKind.Interface),
      (S[y.memberFunction] = i.languages.SymbolKind.Method),
      (S[y.memberVariable] = i.languages.SymbolKind.Property),
      (S[y.memberGetAccessor] = i.languages.SymbolKind.Property),
      (S[y.memberSetAccessor] = i.languages.SymbolKind.Property),
      (S[y.variable] = i.languages.SymbolKind.Variable),
      (S[y.const] = i.languages.SymbolKind.Variable),
      (S[y.localVariable] = i.languages.SymbolKind.Variable),
      (S[y.variable] = i.languages.SymbolKind.Variable),
      (S[y.function] = i.languages.SymbolKind.Function),
      (S[y.localFunction] = i.languages.SymbolKind.Function);
    var w = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
          ...
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (u) {
              switch (u.label) {
                case 0:
                  return (
                    (i = e.uri), (s = e.getOffsetAt(t)), [4, this._worker(i)]
                  );
                case 1:
                  return (
                    (o = u.sent()),
    ...
    var k = (function (e) {
      ...
      return (
              ...
              switch (d.label) {
                ...
                case 1:
                  return (
                    ...
                    e.isDisposed()
                      ? [2]
                      : [4, l.getCodeFixesAtPosition(r.toString(), i, s, a, o)]
                  );
                case 2:
                  return !(u = d.sent()) || e.isDisposed()
                    ...
                    : [
                        2,
                        {
                          actions: u
                            ...
                            .map(function (t) {
                              return c._tsCodeFixActionToMonacoCodeAction(
                                e,
                                n,
                                t,
                              );
        ...
        (t.prototype._tsCodeFixActionToMonacoCodeAction = function (e, t, n) {
          for (var r = [], i = 0, s = n.changes; i < s.length; i++)
            for (var o = 0, a = s[i].textChanges; o < a.length; o++) {
              var l = a[o];
              r.push({
                resource: e.uri,
                edit: {
          ...
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (f) {
              switch (f.label) {
                ...
                case 2:
                  if (!1 === (a = f.sent()).canRename)
                    return [
                      2,
                      { edits: [], rejectReason: a.localizedErrorMessage },
                    ];
                  if (void 0 !== a.fileToRename)
                    throw new Error("Renaming files is not supported.");
                  return [4, o.findRenameLocations(i, s, !1, !1, !1)];
                case 3:
                  if (!(l = f.sent()) || e.isDisposed()) return [2];
                  for (u = [], c = 0, d = l; c < d.length; c++) {
                    if (
                      ((p = d[c]),
                      !(g = this._libFiles.getOrCreateModel(p.fileName)))
                    )
                      throw new Error("Unknown file " + p.fileName + ".");
                    u.push({
                      resource: g.uri,
                      edit: {
      ...
      return (
            ...
            return __generator(this, function (l) {
              switch (l.label) {
                ...
                case 1:
                  return (
                    (o = l.sent()),
                    e.isDisposed() ? [2, []] : [4, o.provideInlayHints(r, i, s)]
                  );
                case 2:
                  return [
                    2,
                    l.sent().map(function (t) {
                      return __assign(__assign({}, t), {
                        position: e.getPositionAt(t.position),
                        kind: a._convertHintKind(t.kind),
                      });
                    }),
                  ];
              }
        ...
        (t.prototype._convertHintKind = function (e) {
          switch (e) {
            ...
            default:
              return i.languages.InlayHintKind.Other;
          }
        }),
        t
      );
    })(l);
    t.InlayHintsAdapter = C;
  },
),
  define(
    ...
    function (e, t, n, r, i) {
      ...
      var s, o;
      function a(e, t) {
        var s = new n.WorkerManager(t, e),
          o = function () {
            for (var e = [], t = 0; t < arguments.length; t++)
              e[t] = arguments[t];
            return s.getLanguageServiceWorker.apply(s, e);
          },
          a = new r.LibFiles(o);
        return (
          i.languages.registerCompletionItemProvider(
            t,
            new r.SuggestAdapter(o),
          ),
          i.languages.registerSignatureHelpProvider(
            t,
            new r.SignatureHelpAdapter(o),
          ),
          i.languages.registerHoverProvider(t, new r.QuickInfoAdapter(o)),
          i.languages.registerDocumentHighlightProvider(
            t,
            new r.OccurrencesAdapter(o),
          ),
          i.languages.registerDefinitionProvider(
            t,
            new r.DefinitionAdapter(a, o),
          ),
          i.languages.registerReferenceProvider(
            t,
            new r.ReferenceAdapter(a, o),
          ),
          i.languages.registerDocumentSymbolProvider(
            t,
            new r.OutlineAdapter(o),
          ),
          i.languages.registerDocumentRangeFormattingEditProvider(
            t,
            new r.FormatAdapter(o),
          ),
          i.languages.registerOnTypeFormattingEditProvider(
            t,
            new r.FormatOnTypeAdapter(o),
          ),
          i.languages.registerCodeActionProvider(t, new r.CodeActionAdaptor(o)),
          i.languages.registerRenameProvider(t, new r.RenameAdapter(a, o)),
          i.languages.registerInlayHintsProvider(t, new r.InlayHintsAdapter(o)),
          new r.DiagnosticsAdapter(a, e, t, o),
          o
        );
      }
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.getTypeScriptWorker =
          t.getJavaScriptWorker =
          t.setupJavaScript =
          t.setupTypeScript =
            void 0),
        ...
        (t.getJavaScriptWorker = function () {
          return new Promise(function (e, t) {
            if (!s) return t("JavaScript not registered!");
            e(s);
          });
        }),
