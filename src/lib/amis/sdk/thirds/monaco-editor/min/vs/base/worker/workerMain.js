      ...
      class D {
        ...
        _remove(s) {
          if (s.prev !== A.Undefined && s.next !== A.Undefined) {
            ...
            s.prev === A.Undefined && s.next === A.Undefined
              ? ((this._first = A.Undefined), (this._last = A.Undefined))
              : s.next === A.Undefined
                ? ((this._last = this._last.prev),
                  (this._last.next = A.Undefined))
                : s.prev === A.Undefined &&
                  ((this._first = this._first.next),
                  (this._first.prev = A.Undefined));
          this._size -= 1;
        }
        *[Symbol.iterator]() {
          let s = this._first;
        ...
        stop() {
          if (this._stopWatch) {
            ...
            (this._elapsedOverall += h),
              ...
              console.info(
                `did FIRE ${this._name}: elapsed_ms: ${h.toFixed(5)}, listener: ${this._listenerCount} (elapsed_overall: ${this._elapsedOverall.toFixed(2)}, invocations: ${this._invocationCount})`,
              ),
      ...
      class N {
        ...
        _step() {
          ...
          for (let L = 0; L < 64; L += 4)
            h.setUint32(L, S.getUint32(L, !1), !1);
          ...
          o.authority && o.path.length > 1 && o.scheme === "file"
            ...
            : o.path.charCodeAt(0) === 47 &&
                ((o.path.charCodeAt(1) >= 65 && o.path.charCodeAt(1) <= 90) ||
                  (o.path.charCodeAt(1) >= 97 &&
                    o.path.charCodeAt(1) <= 122)) &&
    ...
    j(z[3], G([0, 1]), function (F, n) {
      ...
      class A {
        ...
        with(w = this.lineNumber, s = this.column) {
          return w === this.lineNumber && s === this.column
            ? this
            : new A(w, s);
        }
        delta(w = 0, s = 0) {
    ...
    function (F, n, A, D, w, s, d, a, u, c, C, e, f, m, N) {
      ...
      class b extends u.MirrorTextModel {
        ...
        getValueInRange(i) {
          ...
          return (
            v.push(this._lines[g].substring(0, i.endColumn - 1)), v.join(r)
          );
        }
        offsetAt(i) {
          return (
...
//# sourceMappingURL=./thirds/monaco-editor/min-maps/vs/base/worker/workerMain.js.map
