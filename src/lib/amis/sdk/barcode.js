...
amis.define("2b991a9", function (t, e, n, i) {
  "use strict";
...
amis.define("49ec689", function (e, t, n, r) {
  "use strict";
        ...
        return (
          ...
          n.mod43 &&
            (e += (function (e) {
              ...
              (function (e) {
                for (var t = 0, n = 0; n < e.length; n++) t += s(e[n]);
                return (t %= 43);
              })(e),
            )),
          (function (e, t) {
        ...
        u(t, [
          {
            key: "encode",
            value: function () {
              for (var e = l("*"), t = 0; t < this.data.length; t++)
                e += l(this.data[t]) + "0";
              return { data: (e += l("*")), text: this.text };
            },
          },
          {
            key: "valid",
...
amis.define("a158331", function (e, r, S, _) {
  "use strict";
  var A;
  function C(e, r, S) {
    return (
  ...
  var T = (r.SET_A = 0),
    n = (r.SET_B = 1),
    i = (r.SET_C = 2),
    t = ((r.SHIFT = 98), (r.START_A = 103)),
    R = (r.START_B = 104),
    a = (r.START_C = 105);
  (r.MODULO = 103),
    (r.STOP = 106),
    (r.FNC1 = 207),
    (r.SET_BY_CODE = (C((A = {}), t, T), C(A, R, n), C(A, a, i), A)),
    (r.SWAP = { 101: T, 100: n, 99: i }),
    (r.A_START_CHAR = String.fromCharCode(208)),
    (r.B_START_CHAR = String.fromCharCode(209)),
    (r.C_START_CHAR = String.fromCharCode(210)),
    (r.A_CHARS = "[\0-_È-Ï]"),
    (r.B_CHARS = "[ -È-Ï]"),
    (r.C_CHARS = "(Ï*[0-9]{2}Ï*)"),
    (r.BARS = [
...
amis.define("6e63087", function (e, t, r, n) {
  "use strict";
  ...
  var c = (function (e) {
    function t(e, r) {
      ...
      var n = (function (e, t) {
        ...
        this,
        (t.__proto__ || Object.getPrototypeOf(t)).call(this, e.substring(1), r),
      );
      return (
        (n.bytes = e.split("").map(function (e) {
        ...
        [
          ...
          },
          {
            ...
            value: function () {
              ...
              !0 === this.shouldEncodeAsEan128() && e.unshift(s.FNC1);
              var o = t.next(e, 1, n);
              return {
                text:
                  this.text === this.data
                ...
                data:
                  t.getBar(r) +
                  o.result +
                  t.getBar((o.checksum + r) % s.MODULO) +
                  t.getBar(s.STOP),
              };
            },
          },
          {
            ...
            value: function () {
              ...
              return (
                "string" == typeof e && (e = "true" === e.toLowerCase()), e
              );
            },
          },
        ],
        [
          {
            key: "getBar",
            value: function (e) {
              return s.BARS[e] ? s.BARS[e].toString() : "";
            },
          },
          {
            key: "correctIndex",
                      ...
                      (e[0] =
                        n === s.SET_A
                          ...
                          : e[0] < 32
                            ...
                            : e[0]),
                    (o = t.next(e, r + 1, n)));
              } else (i = t.correctIndex(e, n)), (o = t.next(e, r + 1, n));
              var u = i * r;
              return {
                result: t.getBar(i) + o.result,
                checksum: u + o.checksum,
              };
            },
          },
        ],
...
amis.define("a2625f3", function (n, e, r, t) {
  "use strict";
  Object.defineProperty(e, "__esModule", { value: !0 });
  var u = n("a158331"),
    i = function (n) {
      return n.match(new RegExp("^" + u.A_CHARS + "*"))[0].length;
    },
    a = function (n) {
      return n.match(new RegExp("^" + u.B_CHARS + "*"))[0].length;
    },
    C = function (n) {
      return n.match(new RegExp("^" + u.C_CHARS + "*"))[0];
    };
  function g(n, e) {
    var r = e ? u.A_CHARS : u.B_CHARS,
      t = n.match(new RegExp("^(" + r + "+?)(([0-9]{2}){2,})([^0-9]|$)"));
    if (t) return t[1] + String.fromCharCode(204) + f(n.substring(t[1].length));
    var i = n.match(new RegExp("^" + r + "+"))[0];
    return i.length === n.length
      ? n
      : i + String.fromCharCode(e ? 205 : 206) + g(n.substring(i.length), !e);
  }
  function f(n) {
    var e = C(n),
      r = e.length;
    ...
    n = n.substring(r);
    var t = i(n) >= a(n);
    return e + String.fromCharCode(t ? 206 : 205) + g(n, t);
  }
  e.default = function (n) {
    var e = void 0;
    if (C(n).length >= 2) e = u.C_START_CHAR + f(n);
    else {
      var r = i(n) > a(n);
      e = (r ? u.A_START_CHAR : u.B_START_CHAR) + g(n, r);
    }
    return e.replace(/[\xCD\xCE]([^])[\xCD\xCE]/, function (n, e) {
      return String.fromCharCode(203) + e;
    });
  };
}); /*!node_modules/jsbarcode/bin/barcodes/CODE128/CODE128_AUTO.js*/
amis.define("1fd4d53", function (e, t, o, n) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var r = i(e("6e63087")),
    f = i(e("a2625f3"));
  ...
  var c = (function (e) {
    function t(e, o) {
      if (
        ...
        n = u(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, o));
      return u(n);
    }
    return (
      (function (e, t) {
...
amis.define("6453c8c", function (e, t, n, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var o,
    u = (function () {
...
amis.define("da0e4fd", function (e, t, n, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var o,
    u = (function () {
...
amis.define("bf9da82", function (e, t, n, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var o,
    u = (function () {
...
amis.define("1128939", function (e, d, f, t) {
  "use strict";
  Object.defineProperty(d, "__esModule", { value: !0 }),
    (d.CODE128C = d.CODE128B = d.CODE128A = d.CODE128 = void 0);
  var u = l(e("1fd4d53")),
    a = l(e("6453c8c")),
    C = l(e("da0e4fd")),
    O = l(e("bf9da82"));
  ...
  (d.CODE128 = u.default),
    (d.CODE128A = a.default),
    (d.CODE128B = C.default),
    (d.CODE128C = O.default);
}); /*!node_modules/jsbarcode/bin/barcodes/EAN_UPC/constants.js*/
amis.define("4c0d298", function (L, G, e, E) {
  "use strict";
...
amis.define("28aaac7", function (n, e, t, r) {
  "use strict";
  Object.defineProperty(e, "__esModule", { value: !0 });
  var u = n("4c0d298");
...
amis.define("8db4c5a", function (t, e, n, o) {
  "use strict";
  Object.defineProperty(e, "__esModule", { value: !0 });
  var r = (function () {
      function t(t, e) {
  ...
  var f = (function (t) {
    function e(t, n) {
      ...
      return (
        ...
        (o.guardHeight = n.height + o.fontSize / 2 + n.textMargin),
        o
      );
    }
    return (
      ...
      r(e, [
        ...
        },
        {
          ...
          value: function () {
            ...
            return [
              { data: i.SIDE_BIN, options: e },
              { data: this.leftEncode(), text: this.leftText(), options: t },
              { data: i.MIDDLE_BIN, options: e },
...
amis.define("a318f75", function (t, e, o, r) {
  "use strict";
  Object.defineProperty(e, "__esModule", { value: !0 });
  var n,
    i = (function () {
    ...
    l = (function (t) {
      function e(t, o) {
        ...
        var r = (function (t, e) {
          ...
          return !e || ("object" != typeof e && "function" != typeof e) ? t : e;
        })(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, o));
        return (r.lastChar = o.lastChar), r;
      }
      return (
        (function (t, e) {
          if ("function" != typeof e && null !== e)
          ...
          },
          {
            ...
            value: function () {
              var t = this.data.substr(1, 6),
                o = u.EAN13_STRUCTURE[this.data[0]];
              return a(
                e.prototype.__proto__ || Object.getPrototypeOf(e.prototype),
                "leftEncode",
                this,
...
amis.define("ed71c39", function (t, e, r, o) {
  "use strict";
  Object.defineProperty(e, "__esModule", { value: !0 });
  var n,
    i = (function () {
...
amis.define("31ea3a2", function (e, t, n, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var o = (function () {
      function e(e, t) {
      ...
      o(t, [
        ...
        },
        {
          ...
          value: function () {
            ...
            return {
              data: "1011" + (0, u.default)(this.data, t, "01"),
              text: this.text,
            };
          },
        },
...
amis.define("0a114f0", function (e, t, n, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var o = (function () {
      function e(e, t) {
    ...
    return (
      ...
      o(t, [
        ...
        },
        {
          key: "encode",
          value: function () {
            var e = a.EAN2_STRUCTURE[parseInt(this.data) % 4];
            return {
              data: "1011" + (0, u.default)(this.data, e, "01"),
              text: this.text,
            };
          },
        },
...
amis.define("139fc26", function (t, e, i, n) {
  "use strict";
  Object.defineProperty(e, "__esModule", { value: !0 });
  var a = (function () {
    function t(t, e) {
  ...
  var s = (function (t) {
    function e(t, i) {
      ...
      return (
        (n.displayValue = i.displayValue),
        i.fontSize > 10 * i.width
          ? (n.fontSize = 10 * i.width)
          : (n.fontSize = i.fontSize),
        (n.guardHeight = i.height + n.fontSize / 2 + i.textMargin),
        n
      );
    }
    return (
...
amis.define("924d13e", function (t, e, i, n) {
  "use strict";
  Object.defineProperty(e, "__esModule", { value: !0 });
  var r = (function () {
      function t(t, e) {
  ...
  var l = [
    ...
    c = (function (t) {
      function e(t, i) {
        ...
        if (((n.isValid = !1), -1 !== t.search(/^[0-9]{6}$/)))
          (n.middleDigits = t),
            (n.upcA = f(t, "0")),
            (n.text = i.text || "" + n.upcA[0] + t + n.upcA[n.upcA.length - 1]),
            (n.isValid = !0);
        else {
          if (-1 === t.search(/^[01][0-9]{7}$/)) return O(n);
          if (
            ((n.middleDigits = t.substring(1, t.length - 1)),
            (n.upcA = f(n.middleDigits, t[0])),
          ...
          },
          {
            ...
            value: function () {
              var t = this.upcA[0],
                ...
                i = E[parseInt(e)][parseInt(t)];
              return (0, o.default)(this.middleDigits, i);
            },
          },
        ]),
        e
  ...
  function f(t, e) {
    for (
      var i = parseInt(t[t.length - 1]), n = l[i], r = "", o = 0, a = 0;
      a < n.length;
      a++
    ) {
      var s = n[a];
    ...
    return "" + (r = "" + e + r) + (0, u.checksum)(r);
  }
  e.default = c;
}); /*!node_modules/jsbarcode/bin/barcodes/EAN_UPC/index.js*/
amis.define("d05f376", function (e, d, f, a) {
  "use strict";
  Object.defineProperty(d, "__esModule", { value: !0 }),
    (d.UPCE = d.UPC = d.EAN2 = d.EAN5 = d.EAN8 = d.EAN13 = void 0);
  var t = i(e("a318f75")),
    u = i(e("ed71c39")),
    l = i(e("31ea3a2")),
    E = i(e("0a114f0")),
...
amis.define("e317805", function (e, i, t, n) {
  "use strict";
...
amis.define("d8f60f4", function (e, t, n, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var o,
    i = (function () {
          ...
          value: function () {
            var e = this,
              t = this.data
                ...
                .join("");
            return { data: a.START_BIN + t + a.END_BIN, text: this.text };
          },
        },
        {
          key: "encodePair",
          value: function (e) {
            var t = a.BINARIES[e[1]];
            return a.BINARIES[e[0]]
              .split("")
              .map(function (e, n) {
  ...
  })(((o = u) && o.__esModule ? o : { default: o }).default);
  t.default = l;
}); /*!node_modules/jsbarcode/bin/barcodes/ITF/ITF14.js*/
amis.define("1d66cf0", function (e, t, n, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var o,
    u = (function () {
...
amis.define("ebc674c", function (e, d, f, t) {
  "use strict";
  Object.defineProperty(d, "__esModule", { value: !0 }),
  ...
  (d.ITF = u.default), (d.ITF14 = c.default);
}); /*!node_modules/jsbarcode/bin/barcodes/MSI/MSI.js*/
amis.define("4f2095e", function (e, t, n, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var o,
    a = (function () {
...
amis.define("188db03", function (e, n, t, r) {
  "use strict";
  Object.defineProperty(n, "__esModule", { value: !0 }),
    (n.mod10 = function (e) {
      for (var n = 0, t = 0; t < e.length; t++) {
        ...
        (t + e.length) % 2 == 0
          ? (n += r)
          : (n += ((2 * r) % 10) + Math.floor((2 * r) / 10));
      }
      return (10 - (n % 10)) % 10;
    }),
    (n.mod11 = function (e) {
      for (var n = 0, t = [2, 3, 4, 5, 6, 7], r = 0; r < e.length; r++) {
...
amis.define("9277721", function (e, t, o, n) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var r,
    i = e("4f2095e"),
...
amis.define("a312d25", function (e, t, o, n) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var r,
    i = e("4f2095e"),
...
amis.define("517f6af", function (e, t, o, n) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var r,
    f = e("4f2095e"),
    i = (r = f) && r.__esModule ? r : { default: r },
    u = e("188db03");
  var c = (function (e) {
    function t(e, o) {
      return (
...
amis.define("f71cb87", function (e, t, o, n) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var r,
    f = e("4f2095e"),
...
amis.define("641adae", function (e, f, a, d) {
  "use strict";
  Object.defineProperty(f, "__esModule", { value: !0 }),
    (f.MSI1110 = f.MSI1010 = f.MSI11 = f.MSI10 = f.MSI = void 0);
  var t = l(e("4f2095e")),
    u = l(e("9277721")),
    M = l(e("a312d25")),
    I = l(e("517f6af")),
...
amis.define("441b60d", function (e, t, n, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.pharmacode = void 0);
  var o,
          ...
          value: function () {
            for (var e = this.number, t = ""; !isNaN(e) && 0 != e; )
              e % 2 == 0
                ? ((t = "11100" + t), (e = (e - 2) / 2))
                : ((t = "100" + t), (e = (e - 1) / 2));
            return { data: (t = t.slice(0, -2)), text: this.text };
          },
        },
        {
          key: "valid",
...
amis.define("7e7a56a", function (e, t, n, r) {
  "use strict";
...
amis.define("a0977f7", function (e, t, n, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 }),
...
amis.define("7edc8de", function (e, E, a, C) {
  "use strict";
  Object.defineProperty(E, "__esModule", { value: !0 });
  var c = e("49ec689"),
    d = e("1128939"),
...
amis.define("3748391", function (e, r, t, n) {
  "use strict";
  Object.defineProperty(r, "__esModule", { value: !0 });
  var a =
    Object.assign ||
...
amis.define("9e7eaee", function (e, t, a, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.default = function (e) {
      ...
      return (
        (function e(a) {
          if (Array.isArray(a)) for (var r = 0; r < a.length; r++) e(a[r]);
          else (a.text = a.text || ""), (a.data = a.data || ""), t.push(a);
        })(e),
        t
      );
    });
}); /*!node_modules/jsbarcode/bin/help/fixOptions.js*/
amis.define("3c009f0", function (i, n, r, t) {
  "use strict";
  Object.defineProperty(n, "__esModule", { value: !0 }),
    (n.default = function (i) {
      return (
        (i.marginTop = i.marginTop || i.margin),
        (i.marginBottom = i.marginBottom || i.margin),
        (i.marginRight = i.marginRight || i.margin),
        (i.marginLeft = i.marginLeft || i.margin),
        i
      );
    });
}); /*!node_modules/jsbarcode/bin/help/optionsFromStrings.js*/
amis.define("0bb4974", function (e, t, i, a) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.default = function (e) {
      var t = [
      ...
      for (var i in t)
        t.hasOwnProperty(i) &&
          ((i = t[i]), "string" == typeof e[i] && (e[i] = parseInt(e[i], 10)));
      "string" == typeof e.displayValue &&
        (e.displayValue = "false" != e.displayValue);
      return e;
    });
}); /*!node_modules/jsbarcode/bin/options/defaults.js*/
amis.define("40189a2", function (t, i, o, e) {
  "use strict";
  Object.defineProperty(i, "__esModule", { value: !0 });
  var n = {
    width: 2,
...
amis.define("478010e", function (e, t, a, r) {
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var u = d(e("0bb4974")),
    o = d(e("40189a2"));
  ...
  t.default = function (e) {
    ...
    for (var a in o.default)
      o.default.hasOwnProperty(a) &&
        (e.hasAttribute("jsbarcode-" + a.toLowerCase()) &&
          (t[a] = e.getAttribute("jsbarcode-" + a.toLowerCase())),
        e.hasAttribute("data-" + a.toLowerCase()) &&
          (t[a] = e.getAttribute("data-" + a.toLowerCase())));
    return (
      (t.value =
...
amis.define("011d369", function (t, e, n, i) {
  "use strict";
  Object.defineProperty(e, "__esModule", { value: !0 }),
  ...
  function u(t, e, n) {
    ...
    i.font = e.fontOptions + " " + e.fontSize + "px " + e.font;
    var a = i.measureText(t);
    return a ? a.width : 0;
  }
  (e.getMaximumHeightOfEncodings = function (t) {
    ...
    (e.getEncodingHeight = d),
    (e.getBarcodePadding = g),
    (e.calculateEncodingAttributes = function (t, e, n) {
      for (var i = 0; i < t.length; i++) {
        var a,
          o = t[i],
          f = (0, r.default)(e, o.options);
        a = f.displayValue ? u(o.text, f, n) : 0;
        var l = o.data.length * f.width;
        (o.width = Math.ceil(Math.max(a, l))),
          (o.height = d(o, f)),
          (o.barcodePadding = g(a, l, f));
      }
    }),
...
amis.define("a44d18c", function (t, n, e, i) {
  "use strict";
  Object.defineProperty(n, "__esModule", { value: !0 });
  var a,
    s = (function () {
      ...
      s(t, [
        {
          ...
          value: function () {
            ...
            for (var t = 0; t < this.encodings.length; t++) {
              var n = (0, r.default)(this.options, this.encodings[t].options);
              this.drawCanvasBarcode(n, this.encodings[t]),
                this.drawCanvasText(n, this.encodings[t]),
        ...
        },
        {
          ...
          value: function () {
            ...
            t.save(),
              (0, h.calculateEncodingAttributes)(
                this.encodings,
                this.options,
                t,
              );
            var n = (0, h.getTotalWidthOfEncodings)(this.encodings),
              e = (0, h.getMaximumHeightOfEncodings)(this.encodings);
            (this.canvas.width =
        ...
        },
        {
          ...
          value: function (t, n) {
            ...
            for (var s = 0; s < a.length; s++) {
              var o = s * t.width + n.barcodePadding;
              "1" === a[s]
                ? i.fillRect(o, e, t.width, t.height)
                : a[s] && i.fillRect(o, e, t.width, t.height * a[s]);
            }
          },
        },
        {
          ...
          value: function (t, n) {
            var e,
              ...
              s = t.fontOptions + " " + t.fontSize + "px " + t.font;
            t.displayValue &&
              ((i =
                "top" == t.textPosition
                  ? t.marginTop + t.fontSize - t.textMargin
              ...
              (a.font = s),
              "left" == t.textAlign || n.barcodePadding > 0
                ? ((e = 0), (a.textAlign = "left"))
                : "right" == t.textAlign
                  ? ((e = n.width - 1), (a.textAlign = "right"))
                  : ((e = n.width / 2), (a.textAlign = "center")),
              a.fillText(n.text, e, i));
          },
        },
        {
...
amis.define("3f0fab8", function (t, e, i, n) {
  "use strict";
  Object.defineProperty(e, "__esModule", { value: !0 });
  var r,
    s = (function () {
        ...
        s(t, [
            ...
            value: function () {
              ...
              for (var e = 0; e < this.encodings.length; e++) {
                var i = this.encodings[e],
                  n = (0, a.default)(this.options, i.options),
                  r = this.createGroup(t, n.marginTop, this.svg);
                this.setGroupOptions(r, n),
                  this.drawSvgBarcode(r, n, i),
                  this.drawSVGText(r, n, i),
                  (t += i.width);
              }
            },
          },
          {
            ...
            value: function () {
              ...
              this.setSvgAttributes(i, e),
                this.options.background &&
                  this.drawRect(0, 0, i, e, this.svg).setAttribute(
                    "style",
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              for (var s = 0, o = 0, a = 0; a < r.length; a++)
                (o = a * e.width + i.barcodePadding),
                  "1" === r[a]
                    ? s++
                    : s > 0 &&
                      (this.drawRect(
          ...
          },
          {
            ...
            value: function (t, e, i) {
              var n,
                r,
                s = this.document.createElementNS(h, "text");
              e.displayValue &&
                (s.setAttribute(
                  "style",
                ...
                "left" == e.textAlign || i.barcodePadding > 0
                  ? ((n = 0), s.setAttribute("text-anchor", "start"))
                  : "right" == e.textAlign
                    ? ((n = i.width - 1), s.setAttribute("text-anchor", "end"))
                    : ((n = i.width / 2),
                      s.setAttribute("text-anchor", "middle")),
                s.setAttribute("x", n),
                s.setAttribute("y", r),
                s.appendChild(this.document.createTextNode(i.text)),
                t.appendChild(s));
            },
          },
          {
          ...
          },
          {
            key: "createGroup",
            value: function (t, e, i) {
              var n = this.document.createElementNS(h, "g");
              return (
                n.setAttribute("transform", "translate(" + t + ", " + e + ")"),
                i.appendChild(n),
                n
              );
            },
          ...
          },
          {
            ...
            value: function (t, e, i, n, r) {
              var s = this.document.createElementNS(h, "rect");
              return (
                s.setAttribute("x", t),
                s.setAttribute("y", e),
...
amis.define("d11b94e", function (e, n, t, i) {
  "use strict";
  Object.defineProperty(n, "__esModule", { value: !0 });
  var o = (function () {
    function e(e, n) {
...
amis.define("5ea959a", function (e, a, d, t) {
  "use strict";
...
amis.define("c2005bb", function (t, e, n, o) {
  "use strict";
  function r(t, e) {
    if (!(t instanceof e))
      throw new TypeError("Cannot call a class as a function");
...
amis.define("b1ed82c", function (e, n, t, r) {
  "use strict";
  Object.defineProperty(n, "__esModule", { value: !0 });
  var o =
  ...
  function l(e) {
    if ("string" == typeof e)
      return (function (e) {
        ...
        for (var t = [], r = 0; r < n.length; r++) t.push(l(n[r]));
        return t;
      })(e);
    if (Array.isArray(e)) {
      for (var n = [], t = 0; t < e.length; t++) n.push(l(e[t]));
      return n;
    }
    if (
      ...
      return (
        (r = e),
        {
          element: (d = document.createElement("canvas")),
          options: (0, a.default)(r),
          renderer: f.default.CanvasRenderer,
          afterRender: function () {
            r.setAttribute("src", d.toDataURL());
          },
        }
      );
    if (
      (e && e.nodeName && "svg" === e.nodeName.toLowerCase()) ||
      ("undefined" != typeof SVGElement && e instanceof SVGElement)
    )
      return {
        element: e,
        options: (0, a.default)(e),
    ...
    if (e && e.getContext)
      return { element: e, renderer: f.default.CanvasRenderer };
    if (e && "object" === (void 0 === e ? "undefined" : o(e)) && !e.nodeName)
      return { element: e, renderer: f.default.ObjectRenderer };
    throw new u.InvalidElementException();
    var r, d;
  }
  n.default = l;
}); /*!node_modules/jsbarcode/bin/exceptions/ErrorHandler.js*/
amis.define("408390c", function (t, n, e, i) {
  "use strict";
  Object.defineProperty(n, "__esModule", { value: !0 });
  var a = (function () {
    function t(t, n) {
...
amis.define("196b7c7", function (e, r, t, o) {
  "use strict";
  var n = c(e("7edc8de")),
    i = c(e("3748391")),
    a = c(e("9e7eaee")),
  ...
  var h = function () {},
    _ = function (e, r, t) {
      ...
      return (
        (o._renderProperties = (0, d.default)(e)),
        (o._encodings = []),
        (o._options = l.default),
        (o._errorHandler = new f.default(o)),
        void 0 !== r &&
          ((t = t || {}).format || (t.format = P()),
          o.options(t)[t.format](r, t).render()),
        o
      );
    };
  for (var v in ((_.getModule = function (e) {
    return n.default[e];
  }),
  n.default))
  ...
  function y(e, r) {
    h.prototype[r] =
      h.prototype[r.toUpperCase()] =
      h.prototype[r.toLowerCase()] =
        function (t, o) {
          var n = this;
          return n._errorHandler.wrapBarcodeCall(function () {
            o.text = void 0 === o.text ? void 0 : "" + o.text;
            var a = (0, i.default)(n._options, o);
            a = (0, u.default)(a);
            var s = e[r],
              d = w(t, s, a);
            return n._encodings.push(d), n;
          });
        };
  }
  function w(e, r, t) {
    var o = new r((e = "" + e), t);
    if (!o.valid()) throw new p.InvalidInputException(o.constructor.name, e);
    var n = o.encode();
    n = (0, a.default)(n);
    for (var s = 0; s < n.length; s++)
      n[s].options = (0, i.default)(t, n[s].options);
    return n;
  }
  function P() {
  ...
  function m(e, r, t) {
    ...
    for (var o = 0; o < r.length; o++)
      (r[o].options = (0, i.default)(t, r[o].options)),
        (0, s.default)(r[o].options);
    (0, s.default)(t),
      new (0, e.renderer)(e.element, r, t).render(),
  ...
  (h.prototype.options = function (e) {
    ...
    (h.prototype.init = function () {
      ...
      if (this._renderProperties)
        for (var r in (Array.isArray(this._renderProperties) ||
          (this._renderProperties = [this._renderProperties]),
        this._renderProperties)) {
          e = this._renderProperties[r];
          var t = (0, i.default)(this._options, e.options);
          "auto" == t.format && (t.format = P()),
            this._errorHandler.wrapBarcodeCall(function () {
              var r = w(t.value, n.default[t.format.toUpperCase()], t);
              m(e, r, t);
            });
        }
    }),
    (h.prototype.render = function () {
      if (!this._renderProperties) throw new p.NoElementException();
      if (Array.isArray(this._renderProperties))
        for (var e = 0; e < this._renderProperties.length; e++)
          m(this._renderProperties[e], this._encodings, this._options);
      else m(this._renderProperties, this._encodings, this._options);
      return this;
    }),
    (h.prototype._defaults = l.default),
    "undefined" != typeof window && (window.JsBarcode = _),
    "undefined" != typeof jQuery &&
      (jQuery.fn.JsBarcode = function (e, r) {
        var t = [];
        return (
